...
public class JavaCXFServerOptionsProvider extends JavaOptionsProvider {
    ...
    public Map<String, String> createOptions() {
        ...
        builder.put(JavaCXFServerCodegen.USE_LOGGING_FEATURE_FOR_TESTS,
                USE_LOGGING_FEATURE_FOR_TESTS);
        builder.put(JavaCXFServerCodegen.USE_BEANVALIDATION_FEATURE, USE_BEANVALIDATION_FEATURE);

        builder.put(JavaCXFServerCodegen.GENERATE_SPRING_BOOT_APPLICATION,
        ...
        builder.put(JavaCXFServerCodegen.GENERATE_NON_SPRING_APPLICATION,
