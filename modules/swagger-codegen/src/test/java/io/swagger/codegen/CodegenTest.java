...
public class CodegenTest {
    ...
    public void formParamTest() {
        ...
        Assert.assertTrue(op.hasConsumes);
        Assert.assertEquals(op.consumes.size(), 1);
        Assert.assertEquals(op.consumes.get(0).get("mediaType"),
    ...
    @Test(
            description = "handle required parameters from a 2.0 spec as required when figuring out Swagger types")
    ...
    public void responseSelectionTest1() {
        final Swagger model =
                parseAndPrepareSwagger("src/test/resources/2_0/responseSelectionTest.json");
        final DefaultCodegen codegen = new DefaultCodegen();
    ...
    @Test(
            description = "select main response from a 2.0 spec using the default keyword when no 2XX code")
    ...
    public void fileResponeseTest() {
        final Swagger model =
                parseAndPrepareSwagger("src/test/resources/2_0/fileResponseTest.json");
        final DefaultCodegen codegen = new DefaultCodegen();
    ...
    public void discriminatorTest() {
        final Swagger model =
                parseAndPrepareSwagger("src/test/resources/2_0/discriminatorTest.json");
        final DefaultCodegen codegen = new DefaultCodegen();
    ...
    public void simpleCompositionTest() {
        ...
        CodegenModel composed =
                codegen.fromModel("SimpleComposition", model, swagger.getDefinitions());
    ...
    public void multiCompositionTest() {
        ...
        CodegenModel composed =
                codegen.fromModel("CompositionOfSimpleComposition", model, swagger.getDefinitions());
    ...
    public void simpleInheritanceTest() {
        ...
        CodegenModel child =
                codegen.fromModel("ChildOfSimpleParent", model, swagger.getDefinitions());
    ...
    public void multiInheritanceTest() {
        ...
        CodegenModel child =
                codegen.fromModel("ChildOfChildOfSimpleParent", model, swagger.getDefinitions());
    ...
    @Test(
            description = "copy properties in multi level inheritance if supportsInheritance is false")
    ...
    public void inheritanceOfComposedModelTest() {
        ...
        CodegenModel child =
                codegen.fromModel("ChildOfComposedParent", model, swagger.getDefinitions());
    ...
    public void multiInheritanceOfComposedModelTest() {
        ...
        CodegenModel child =
                codegen.fromModel("ChildOfChildOfComposedParent", model, swagger.getDefinitions());
    ...
    public void localConsumesAndProducesTest() {
        final Swagger model =
                parseAndPrepareSwagger("src/test/resources/2_0/globalConsumesAndProduces.json");
        final DefaultCodegen codegen = new DefaultCodegen();
