...
public class JavaResteasyServerOptionsTest extends AbstractOptionsTest {
    ...
    protected void setExpectations() {
        new Expectations(clientCodegen) {
            {
                clientCodegen
                        .setModelPackage(JavaResteasyServerOptionsProvider.MODEL_PACKAGE_VALUE);
                times = 1;
                ...
                clientCodegen.setSortParamsByRequiredFlag(Boolean
                        .valueOf(JavaResteasyServerOptionsProvider.SORT_PARAMS_VALUE));
                times = 1;
                clientCodegen
                        .setInvokerPackage(JavaResteasyServerOptionsProvider.INVOKER_PACKAGE_VALUE);
                times = 1;
                ...
                times = 1;
                clientCodegen
                        .setArtifactVersion(JavaResteasyServerOptionsProvider.ARTIFACT_VERSION_VALUE);
                times = 1;
                clientCodegen
                        .setSourceFolder(JavaResteasyServerOptionsProvider.SOURCE_FOLDER_VALUE);
                times = 1;
                clientCodegen
                        .setLocalVariablePrefix(JavaResteasyServerOptionsProvider.LOCAL_PREFIX_VALUE);
                times = 1;
                clientCodegen.setSerializableModel(Boolean
                        .valueOf(JavaResteasyServerOptionsProvider.SERIALIZABLE_MODEL_VALUE));
                times = 1;
                clientCodegen.setFullJavaUtil(Boolean
                        .valueOf(JavaResteasyServerOptionsProvider.FULL_JAVA_UTIL_VALUE));
                times = 1;
                ...
                clientCodegen
                        .setGenerateJbossDeploymentDescriptor(Boolean
                                .valueOf(JavaResteasyServerOptionsProvider.GENERATE_JBOSS_DEPLOYMENT_DESCRIPTOR));

                clientCodegen.setUseBeanValidation(Boolean
                        .valueOf(JavaResteasyServerOptionsProvider.USE_BEANVALIDATION));
                times = 1;
