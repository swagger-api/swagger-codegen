...
public class JavaModelTest {
	...
	public void simpleModelTest() {
		final Model model = new ModelImpl().description("a sample model").property("id", new LongProperty())
				.property("name", new StringProperty().example("Tony")).property("createdAt", new DateTimeProperty())
	...
	public void listPropertyTest() {
		final Model model = new ModelImpl().description("a sample model").property("id", new LongProperty())
				.property("urls", new ArrayProperty().items(new StringProperty())).required("id");
		final DefaultCodegen codegen = new JavaClientCodegen();
		final CodegenModel cm = codegen.fromModel("sample", model);
	...
	public void mapPropertyTest() {
		final Model model = new ModelImpl().description("a sample model")
				.property("translations", new MapProperty().additionalProperties(new StringProperty())).required("id");
		final DefaultCodegen codegen = new JavaClientCodegen();
		final CodegenModel cm = codegen.fromModel("sample", model);
	...
	public void list2DPropertyTest() {
		final Model model = new ModelImpl().name("sample").property("list2D",
				new ArrayProperty().items(new ArrayProperty().items(new RefProperty("Pet"))));
		final DefaultCodegen codegen = new JavaClientCodegen();
		final CodegenModel cm = codegen.fromModel("sample", model);
	...
	public void complexPropertiesTest() {
		final Model model = new ModelImpl().description("a sample model").property("children",
	...
	public void complexMapPropertyTest() {
		final Model model = new ModelImpl().description("a sample model").property("children",
				new MapProperty().additionalProperties(new RefProperty("#/definitions/Children")));
		final DefaultCodegen codegen = new JavaClientCodegen();
		final CodegenModel cm = codegen.fromModel("sample", model);
	...
	public void arrayModelWithItemNameTest() {
		final Model model = new ModelImpl().description("a sample model").property("children",
				new ArrayProperty().description("an array property").items(new RefProperty("#/definitions/Child"))
	...
	public void arrayModelTest() {
		final Model model = new ArrayModel().description("an array model")
	...
	public void mapModelTest() {
		final Model model = new ModelImpl().description("an map model")
	...
	public void upperCaseNamesTest() {
		final Model model = new ModelImpl().description("a model with upper-case property names")
	...
	public void secondCharUpperCaseNamesTest() {
		final Model model = new ModelImpl().description("a model with a 2nd char upper-case property names")
	...
	public void hyphensTest() {
		final Model model = new ModelImpl().description("a sample model").property("created-at",
	...
	public void squareBracketsTest() {
		final Model model = new ModelImpl().description("a sample model").property("query[password]",
				new StringProperty());
		final DefaultCodegen codegen = new JavaClientCodegen();
		final CodegenModel cm = codegen.fromModel("sample", model);
	...
	public void binaryDataTest() {
		final Model model = new ModelImpl().description("model with binary").property("inputBinaryData",
	...
	public void convertParameterTest() {
		final QueryParameter parameter = new QueryParameter().property(new IntegerProperty()).name("limit")
				.required(true);
		final DefaultCodegen codegen = new JavaClientCodegen();
	...
	public void mapWithAnListOfBigDecimalTest() {
		final CodegenModel cm1 = new JavaClientCodegen().fromModel("sample",
				new ModelImpl().description("model with Map<String, List<BigDecimal>>").property("map",
						new MapProperty().additionalProperties(new ArrayProperty(new DecimalProperty()))));
		...
		final CodegenModel cm2 = new JavaClientCodegen().fromModel("sample",
				new ModelImpl().description("model with Map<String, Map<String, List<BigDecimal>>>").property("map",
						new MapProperty().additionalProperties(
								new MapProperty().additionalProperties(new ArrayProperty(new DecimalProperty())))));
	...
	public void classPropertyTest(String baseName, String getter, String setter, String name) {
		final Model model = new ModelImpl().description("a sample model").property(baseName, new StringProperty());
		final DefaultCodegen codegen = new JavaClientCodegen();
		final CodegenModel cm = codegen.fromModel("sample", model);
	...
	private Model createRowIdTestModel() {
		Property ROW_ID = new LongProperty();
		ROW_ID.setName("ROW_ID");
		Property ROWID = new StringProperty();
		ROWID.setName("ROWID");
		Map<String, Property> properties = new HashMap<>();
		properties.put("ROW_ID", ROW_ID);
		properties.put("ROWID", ROWID);
		final Model model = new ModelImpl().name("PRAWJ202").type("object");
		model.setDescription("a sample model");
	...
	public void classPropertyGetterSetterCamelizeTest() {
		// Code generation with 'PascalCase' - default behavior
		final DefaultCodegen codegen = new JavaClientCodegen();
		final CodegenModel cm = codegen.fromModel("PRAWJ202", createRowIdTestModel());
		int found = 0;
		for (CodegenProperty property : cm.vars) {
			if ("ROWID".equals(property.name)) {
				Assert.assertEquals(property.baseName, "ROWID");
