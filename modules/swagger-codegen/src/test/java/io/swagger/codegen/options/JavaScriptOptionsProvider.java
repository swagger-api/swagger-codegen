...
public class JavaScriptOptionsProvider implements OptionsProvider {
    ...
    public static final String PROJECT_DESCRIPTION_VALUE =
            "Tests JavaScript code generator options";
    ...
    public JavaScriptOptionsProvider() {
        ...
        options =
                new ImmutableMap.Builder<String, String>()
                        ...
                        .put(JavascriptClientCodegen.PROJECT_LICENSE_NAME,
                        ...
                        .put(CodegenConstants.ALLOW_UNICODE_IDENTIFIERS,
                                ALLOW_UNICODE_IDENTIFIERS_VALUE).build();
    }
