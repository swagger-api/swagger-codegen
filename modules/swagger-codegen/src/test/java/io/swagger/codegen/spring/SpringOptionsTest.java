        ...
        new Expectations(clientCodegen) {
            {
                ...
                clientCodegen.setSortParamsByRequiredFlag(Boolean
                        .valueOf(SpringOptionsProvider.SORT_PARAMS_VALUE));
                times = 1;
                ...
                clientCodegen.setSerializableModel(Boolean
                        .valueOf(SpringOptionsProvider.SERIALIZABLE_MODEL_VALUE));
                times = 1;
                clientCodegen.setLibrary(SpringOptionsProvider.LIBRARY_VALUE);
                times = 1;
                clientCodegen.setFullJavaUtil(Boolean
                        .valueOf(SpringOptionsProvider.FULL_JAVA_UTIL_VALUE));
                times = 1;
                ...
                times = 1;
                clientCodegen.setInterfaceOnly(Boolean
                        .valueOf(SpringOptionsProvider.INTERFACE_ONLY));
                times = 1;
                clientCodegen.setDelegatePattern(Boolean
                        .valueOf(SpringOptionsProvider.DELEGATE_PATTERN));
                times = 1;
                clientCodegen.setSingleContentTypes(Boolean
                        .valueOf(SpringOptionsProvider.SINGLE_CONTENT_TYPES));
                times = 1;
                ...
                clientCodegen.setUseBeanValidation(Boolean
                        .valueOf(SpringOptionsProvider.USE_BEANVALIDATION));
                times = 1;
