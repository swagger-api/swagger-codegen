...
public class SpringModelTest {
    ...
    public void simpleModelTest() {
        final Model model = new ModelImpl()
                ...
                .required("id")
                .required("name");
        final DefaultCodegen codegen = new SpringCodegen();
    ...
    public void mapWithAnListOfBigDecimalTest() {
        final CodegenModel cm1 = new SpringCodegen().fromModel("sample", new ModelImpl()
        ...
        final CodegenModel cm2 = new SpringCodegen().fromModel("sample", new ModelImpl()
