        ...
        new Expectations(clientCodegen) {
            {
                ...
                clientCodegen.setSortParamsByRequiredFlag(Boolean
                        .valueOf(JavaScriptOptionsProvider.SORT_PARAMS_VALUE));
                times = 1;
                // clientCodegen.setInvokerPackage(JavaScriptOptionsProvider.INVOKER_PACKAGE_VALUE);
                // times = 1;
                ...
                times = 1;
                clientCodegen
                        .setProjectDescription(JavaScriptOptionsProvider.PROJECT_DESCRIPTION_VALUE);
                times = 1;
                clientCodegen.setProjectVersion(JavaScriptOptionsProvider.PROJECT_VERSION_VALUE);
                times = 1;
                clientCodegen
                        .setProjectLicenseName(JavaScriptOptionsProvider.PROJECT_LICENSE_NAME_VALUE);
                times = 1;
                clientCodegen.setUsePromises(Boolean
                        .valueOf(JavaScriptOptionsProvider.USE_PROMISES_VALUE));
                times = 1;
                clientCodegen.setUseInheritance(Boolean
                        .valueOf(JavaScriptOptionsProvider.USE_INHERITANCE_VALUE));
                times = 1;
                clientCodegen.setEmitModelMethods(Boolean
                        .valueOf(JavaScriptOptionsProvider.EMIT_MODEL_METHODS_VALUE));
                times = 1;
                clientCodegen.setEmitJSDoc(Boolean
                        .valueOf(JavaScriptOptionsProvider.EMIT_JS_DOC_VALUE));
                times = 1;
            }
        };
    }
