...
import io.swagger.codegen.languages.UE4CPPGenerator;

import java.util.Map;

public class UE4CPPOptionsProvider implements OptionsProvider {
    ...
    public Map<String, String> createOptions() {
        ...
        return builder.put(CodegenConstants.SORT_PARAMS_BY_REQUIRED_FLAG, SORT_PARAMS_VALUE)
                ...
                .put(UE4CPPGenerator.CPP_NAMESPACE, CPP_NAMESPACE_VALUE)
