...
public class JavaOptionsProvider implements OptionsProvider {
    ...
    public static final String SCM_CONNECTION_VALUE =
            "scm:git:git@github.com:swagger-api/swagger-codegen.git";
    public static final String SCM_DEVELOPER_CONNECTION_VALUE =
            "scm:git:git@github.com:swagger-api/swagger-codegen.git";
    ...
    public static final String ARTIFACT_URL_VALUE =
    ...
    public JavaOptionsProvider() {
        options =
                new ImmutableMap.Builder<String, String>()
                        ...
                        .put(CodegenConstants.SCM_DEVELOPER_CONNECTION,
                                SCM_DEVELOPER_CONNECTION_VALUE)
                        ...
                        .put(CodegenConstants.DEVELOPER_ORGANIZATION_URL,
                                DEVELOPER_ORGANIZATION_URL_VALUE)
                        ...
                        .put(CodegenConstants.ALLOW_UNICODE_IDENTIFIERS,
    ...
    public JavaOptionsProvider(Map<String, String> additionalOptions) {
        options =
                new ImmutableMap.Builder<String, String>().putAll(options)
                        .putAll(additionalOptions).build();
    }
