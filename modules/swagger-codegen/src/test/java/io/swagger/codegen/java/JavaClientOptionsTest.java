        ...
        new Expectations(clientCodegen) {
            {
                ...
                clientCodegen.setSortParamsByRequiredFlag(Boolean
                        .valueOf(JavaClientOptionsProvider.SORT_PARAMS_VALUE));
                times = 1;
                ...
                times = 1;
                clientCodegen
                        .setArtifactDescription(JavaClientOptionsProvider.ARTIFACT_DESCRIPTION_VALUE);
                times = 1;
                clientCodegen.setScmConnection(JavaClientOptionsProvider.SCM_CONNECTION_VALUE);
                times = 1;
                clientCodegen
                        .setScmDeveloperConnection(JavaClientOptionsProvider.SCM_DEVELOPER_CONNECTION_VALUE);
                times = 1;
                ...
                times = 1;
                clientCodegen
                        .setDeveloperOrganization(JavaClientOptionsProvider.DEVELOPER_ORGANIZATION_VALUE);
                times = 1;
                clientCodegen
                        .setDeveloperOrganizationUrl(JavaClientOptionsProvider.DEVELOPER_ORGANIZATION_URL_VALUE);
                times = 1;
                ...
                clientCodegen.setSerializableModel(Boolean
                        .valueOf(JavaClientOptionsProvider.SERIALIZABLE_MODEL_VALUE));
                times = 1;
                clientCodegen.setLibrary(JavaClientOptionsProvider.DEFAULT_LIBRARY_VALUE);
                times = 1;
                clientCodegen.setFullJavaUtil(Boolean
                        .valueOf(JavaClientOptionsProvider.FULL_JAVA_UTIL_VALUE));
                times = 1;
                clientCodegen.setUseBeanValidation(Boolean
                        .valueOf(JavaClientOptionsProvider.USE_BEANVALIDATION));
                times = 1;
                clientCodegen.setUseBeanValidation(Boolean
                        .valueOf(JavaClientOptionsProvider.PERFORM_BEANVALIDATION));
                times = 1;
            }
        };
    }
