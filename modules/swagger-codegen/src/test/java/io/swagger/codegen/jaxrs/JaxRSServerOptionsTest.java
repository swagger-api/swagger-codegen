        ...
        new Expectations(clientCodegen) {
            {
                ...
                clientCodegen.setSortParamsByRequiredFlag(Boolean
                        .valueOf(JaxRSServerOptionsProvider.SORT_PARAMS_VALUE));
                times = 1;
                ...
                times = 1;
                clientCodegen
                        .setArtifactDescription(JaxRSServerOptionsProvider.ARTIFACT_DESCRIPTION_VALUE);
                times = 1;
                clientCodegen.setScmConnection(JaxRSServerOptionsProvider.SCM_CONNECTION_VALUE);
                times = 1;
                clientCodegen
                        .setScmDeveloperConnection(JaxRSServerOptionsProvider.SCM_DEVELOPER_CONNECTION_VALUE);
                times = 1;
                ...
                times = 1;
                clientCodegen
                        .setDeveloperOrganization(JaxRSServerOptionsProvider.DEVELOPER_ORGANIZATION_VALUE);
                times = 1;
                clientCodegen
                        .setDeveloperOrganizationUrl(JaxRSServerOptionsProvider.DEVELOPER_ORGANIZATION_URL_VALUE);
                times = 1;
                ...
                clientCodegen.setSerializableModel(Boolean
                        .valueOf(JaxRSServerOptionsProvider.SERIALIZABLE_MODEL_VALUE));
                times = 1;
                ...
                clientCodegen.setFullJavaUtil(Boolean
                        .valueOf(JaxRSServerOptionsProvider.FULL_JAVA_UTIL_VALUE));
                times = 1;
                ...
                clientCodegen.setUseBeanValidation(Boolean
                        .valueOf(JaxRSServerOptionsProvider.USE_BEANVALIDATION));
                times = 1;
            }
        };
    }
