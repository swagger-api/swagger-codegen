...
class HttpClient implements IHttpClient {
    ...
    get(url: string, headers?: _.Dictionary<string>): Rx.Observable<HttpResponse> {
        return this.performNetworkCall(url, "get", undefined, headers);
    }

    post(url: string, body: {}|FormData, headers?: _.Dictionary<string>): Rx.Observable<HttpResponse> {
        return this.performNetworkCall(url, "post", this.getJsonBody(body), this.addJsonHeaders(headers));
    }

    put(url: string, body: {}, headers?: _.Dictionary<string>): Rx.Observable<HttpResponse> {
        return this.performNetworkCall(url, "put", this.getJsonBody(body), this.addJsonHeaders(headers));
    }

    delete(url: string, headers?: _.Dictionary<string>): Rx.Observable<HttpResponse> {
    ...
    private performNetworkCall(url: string, method: string, body?: any, headers?: _.Dictionary<string>): Rx.Observable<HttpResponse> {
