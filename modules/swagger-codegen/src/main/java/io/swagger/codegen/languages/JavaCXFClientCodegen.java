...
public class JavaCXFClientCodegen extends AbstractJavaCodegen implements BeanValidationFeatures,
        JaxbFeatures, GzipTestFeatures, LoggingTestFeatures {
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey(USE_BEANVALIDATION)) {
            boolean useBeanValidationProp =
                    convertPropertyToBooleanAndWriteBack(USE_BEANVALIDATION);
