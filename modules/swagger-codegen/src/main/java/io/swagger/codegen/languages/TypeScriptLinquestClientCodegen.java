...
public class TypeScriptLinquestClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public TypeScriptLinquestClientCodegen() {
        super();
        ...
        outputFolder = "generated-code/typescript-linquest";
        embeddedTemplateDir = templateDir = "typescript-linquest";
    ...
    public String getName() {
        return "typescript-linquest";
    }

    @Override
    public String getHelp() {
        return "Generates a TypeScript client library for the Linquest framework.";
    }
