...
public class ScalaClientCodegen extends AbstractScalaCodegen implements CodegenConfig {
    ...
    public ScalaClientCodegen() {
        ...
        setReservedWordsLowerCase(Arrays.asList(
                ...
                "path", "contentTypes", "contentType", "queryParams", "headerParams", "formParams",
                "postBody",
                "mp",
                "basePath",
                "apiInvoker",
        ...
        supportingFiles.add(new SupportingFile("apiInvoker.mustache", (sourceFolder
                + File.separator + invokerPackage).replace(".", java.io.File.separator),
                "ApiInvoker.scala"));
        ...
        supportingFiles.add(new SupportingFile("gradle.properties.mustache", "",
                "gradle.properties"));
        // gradleWrapper files
