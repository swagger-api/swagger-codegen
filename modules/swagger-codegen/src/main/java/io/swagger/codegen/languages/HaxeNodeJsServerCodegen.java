...
public class HaxeNodeJSServerCodegen extends DefaultCodegen implements CodegenConfig {
    protected String apiVersion = "1.0.0";
    protected int serverPort = 8080;
    protected String projectName = "swagger-server";

    public HaxeNodeJSServerCodegen() {
        super();

        // set the output folder here
        outputFolder = "generated-code/haxe-nodejs";
         ...
         */
        embeddedTemplateDir = templateDir = "haxe-nodejs";
        ...
        if (System.getProperty("noservice") == null) {
            apiTemplateFiles.put(
                    ...
                    "Service.hx");       // the extension for each file to write
        }
    }
    ...
    public String getHelp() {
        return "Generates a nodejs server library written usable with haxe using the swagger-tools project.  By default, " +
