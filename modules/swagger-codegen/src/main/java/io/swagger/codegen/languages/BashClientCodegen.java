...
public class BashClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public BashClientCodegen() {
        ...
        /**
         * Allow the user to force the script to always include certain cURL comamnds
         */
         ...
         */
        reservedWords =
                new HashSet<String>(Arrays.asList("case", "do", "done", "elif", "else", "esac",
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey(PROCESS_MARKDOWN)) {
            setProcessMarkdown(Boolean.parseBoolean(additionalProperties.get(PROCESS_MARKDOWN)
                    .toString()));
        }

        if (additionalProperties.containsKey(GENERATE_BASH_COMPLETION)) {
            setGenerateBashCompletion(Boolean.parseBoolean(additionalProperties.get(
                    GENERATE_BASH_COMPLETION).toString()));
        }
        ...
        if (additionalProperties.containsKey(GENERATE_ZSH_COMPLETION)) {
            setGenerateZshCompletion(Boolean.parseBoolean(additionalProperties.get(
                    GENERATE_ZSH_COMPLETION).toString()));
        }
        ...
        if (additionalProperties.containsKey(HOST_ENVIRONMENT_VARIABLE_NAME)) {
            setHostEnvironmentVariable(additionalProperties.get(HOST_ENVIRONMENT_VARIABLE_NAME)
                    .toString());
        ...
        if (additionalProperties.containsKey(BASIC_AUTH_ENVIRONMENT_VARIABLE_NAME)) {
            setBasicAuthEnvironmentVariable(additionalProperties.get(
                    BASIC_AUTH_ENVIRONMENT_VARIABLE_NAME).toString());
        ...
        if (additionalProperties.containsKey(APIKEY_AUTH_ENVIRONMENT_VARIABLE_NAME)) {
            setApiKeyAuthEnvironmentVariable(additionalProperties.get(
                    APIKEY_AUTH_ENVIRONMENT_VARIABLE_NAME).toString());
        ...
        supportingFiles.add(new SupportingFile("bash-completion.mustache", "", scriptName
                + ".bash-completion"));
    ...
    public CodegenParameter fromParameter(Parameter param, Set<String> imports) {
        ...
        if (param instanceof BodyParameter) {
            ...
            if (sparam.getCollectionFormat() != null && !sparam.getCollectionFormat().isEmpty()) {
    ...
    public String escapeText(String input) {
         ...
         * remove standalone '\'
         *
         * replace " with \" outter unescape to retain the original multi-byte characters
         */
        result =
                escapeUnsafeCharacters(StringEscapeUtils
                        .unescapeJava(StringEscapeUtils.escapeJava(result).replace("\\/", "/"))
                        .replace("\\", "\\\\").replace("\"", "\\\""));
        ...
        if (this.processMarkdown) {
             ...
             */
            result =
                    result.replaceAll("(?m)(^|\\s)\\*{2}([\\w\\d ]+)\\*{2}($|\\s)",
                            "\\$\\(tput bold\\) $2 \\$\\(tput sgr0\\)");

            result =
                    result.replaceAll("(?m)(^|\\s)_{2}([\\w\\d ]+)_{2}($|\\s)",
                            "\\$\\(tput bold\\) $2 \\$\\(tput sgr0\\)");
            /**
             ...
             */
            result =
                    result.replaceAll("(?m)(^|\\s)\\*{1}([\\w\\d ]+)\\*{1}($|\\s)",
                            "\\$\\(tput dim\\) $2 \\$\\(tput sgr0\\)");

            result =
                    result.replaceAll("(?m)(^|\\s)_{1}([\\w\\d ]+)_{1}($|\\s)",
                            "\\$\\(tput dim\\) $2 \\$\\(tput sgr0\\)");
        ...
        for (CodegenParameter p : op.bodyParams) {
            if (p.dataType != null && definitions.get(p.dataType) != null) {
                ...
                if (operation.getConsumes() != null
                     ...
                     */
                    p.vendorExtensions.put("x-codegen-body-example", definitions.get(p.dataType)
                            .getExample());
                }
            }
        }
    ...
    public void preprocessSwagger(Swagger swagger) {
        ...
        if (swagger.getInfo() != null && swagger.getInfo().getVendorExtensions() != null) {
            ...
            if (bash_codegen_app_description != null) {
                ...
                bash_codegen_app_description = escapeText(bash_codegen_app_description);
