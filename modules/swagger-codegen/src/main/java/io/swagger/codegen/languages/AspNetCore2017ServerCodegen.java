...
public class AspNetCore2017ServerCodegen extends AbstractCSharpCodegen {

    private String packageGuid = "{" + randomUUID().toString().toUpperCase() + "}";

    @SuppressWarnings("hiding")
    protected Logger LOGGER = LoggerFactory.getLogger(AspNetCore2017ServerCodegen.class);

    public AspNetCore2017ServerCodegen() {
        super();
