...
public class LatexGenerator extends DefaultCodegen implements CodegenConfig {
    ...
    public LatexGenerator() {
        super();
        outputFolder = "docs";
        embeddedTemplateDir = templateDir = "latex";
        ...
        supportingFiles.add(new SupportingFile("main.mustache", "", "main.tex"));
