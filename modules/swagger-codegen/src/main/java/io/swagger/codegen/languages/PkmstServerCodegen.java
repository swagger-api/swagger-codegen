...
public class PkmstServerCodegen extends DefaultCodegen implements CodegenConfig {
	...
	public void processOpts() {
		...
		/*
		 * this.supportingFiles.add(new SupportingFile( "gatling" + File.separator +
		 * "package.mustache", ("src")+ File.separator + ("test")+ File.separator +
		 * ("scala")+ File.separator + ("scalaFiles").replace(".",
		 * java.io.File.separator), "package.info"));
		 */
	 ...
	 *            An object that will assign the data to the respective fields in
	 *            the model.
	 */
	...
	public String toModelName(final String name) {
		// We need to check if import-mapping has a different model for this class, so
		// we use it
