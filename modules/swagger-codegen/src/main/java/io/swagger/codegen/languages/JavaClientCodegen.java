                   ...
                   GzipFeatures
{
    ...
    public JavaClientCodegen() {
        ...
        supportedLibraries.put("resttemplate", "HTTP client: Spring RestTemplate 4.3.9-RELEASE. JSON processing: Jackson 2.9.10. Using -Dspring5=true uses Spring 5.1.5");
