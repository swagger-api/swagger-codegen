                   ...
                   GzipFeatures
{
	 ...
	 * <br>Rather, we create as many combinations as there are optional parameters. 
	 * <br>The reason behind this is: The useOverloading parameter triggering this logic is intended to spare autogenerated java clients
	 * from compile time errors due to new optional parameters having been added to the swagger doc. 
	 * <br>As such, we do not care about all combinations. We only care about creating:
	 * <ol>
	 ...
	 * <li>a signature with the mandatory arguments plus the first and second optional argument
	 * <li>etc
