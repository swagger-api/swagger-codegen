...
public class AspNetCoreServerCodegen extends AbstractCSharpCodegen {
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile("Extensions" + File.separator + "BasePathDocumentFilter.mustache", packageFolder + File.separator + "Extensions", "BasePathDocumentFilter.cs"));
