 ...
 */
public class JavaPKMSTServerCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public JavaPKMSTServerCodegen() {
        ...
        this.languageSpecificPrimitives = new HashSet<String>(Arrays.asList("String", "boolean", "Boolean", "Double",
    ...
    private static CodegenModel reconcileInlineEnums(CodegenModel codegenModel, CodegenModel parentCodegenModel) {
        ...
        // dealing with models that have subTypes. To clean this up, we will
        // analyze
        // the parent and child models, look for enums that match, and remove
        // them from the child models and leave them in the parent.
        // Because the child models extend the parents, the enums will be
        // available via
        // the parent.
        ...
        if (removedChildEnum) {
            // If we removed an entry from this model's vars, we need to ensure
            // hasMore is
            // updated
    ...
    public void processOpts() {
        ...
        if (this.additionalProperties.containsKey("basePackage")) {
            ...
            // this.additionalProperties.put(BASE_PACKAGE,
            // this.getBasePackage());
        } else {
        ...
        /*
         * this.supportingFiles.add(new SupportingFile( "gatling" +
         * File.separator + "package.mustache", ("src")+ File.separator +
         * ("test")+ File.separator + ("scala")+ File.separator +
    ...
    public String toModelName(final String name) {
        // We need to check if import-mapping has a different model for this
        // class, so
        // we use it
        ...
        if (camelizedName.matches("^\\d.*")) {
            final String modelName = "Model" + camelizedName; // e.g.
                                                              // 200Response
                                                              // =>
                                                              // Model200Response
                                                              // (after
    ...
    public CodegenModel fromModel(String name, Model model, Map<String, Model> allDefinitions) {
        ...
        if (allDefinitions != null && codegenModel.parentSchema != null && codegenModel.hasEnums) {
            ...
            codegenModel = JavaPKMSTServerCodegen.reconcileInlineEnums(codegenModel, parentCodegenModel);
        }
        return codegenModel;
    }
    ...
    public String toVarName(String name) {
        // sanitize name
        name = sanitizeName(name); // FIXME: a parameter should not be assigned.
    ...
    public String getTypeDeclaration(Property p) {
        if (p instanceof ArrayProperty) {
            ...
            if (inner == null) {
                ...
                // TODO maybe better defaulting to StringProperty than returning
                // null
                return null;
            }
