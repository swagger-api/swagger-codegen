...
public class GroovyJacksonCodegen extends AbstractJavaCodegen {
    public static final String CONFIG_PACKAGE = "configPackage";
    protected String title = "Petstore Server";
    protected String configPackage = "";

    public GroovyJacksonCodegen() {
        super();
...
//        importMapping.clear();
        ...
        embeddedTemplateDir = templateDir = "GroovyJackson";
        ...
        artifactId = "swagger-groovy-jackson";
        dateLibrary = "java8"; //TODO: add joda support to groovy
    ...
    public String getName() {
        return "groovy-jackson";
    }

    @Override
    public String getHelp() {
        return "Generates a Groovy API client Models using Jackson (beta).";
    }
