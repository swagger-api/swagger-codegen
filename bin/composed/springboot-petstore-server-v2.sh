...
rm -rf samples/composed/server/petstore/springboot-v2/src/main
rm -rf samples/composed/server/petstore/springboot-v2/src/gen
find samples/composed/server/petstore/springboot-v2 -maxdepth 1 -type f ! -name "README.md" -exec rm {} +
