...
rm -rf samples/composed/client/petstore/java/resteasy/src/gen
find samples/composed/client/petstore/java/resteasy -maxdepth 1 -type f ! -name "README.md" -exec rm {} +
