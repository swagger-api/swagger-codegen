...
rm -rf samples/composed/server/petstore/jaxrs/jersey2-useTags/src/main
rm -rf samples/composed/server/petstore/jaxrs/jersey2-useTags/src/gen
find samples/composed/server/petstore/jaxrs/jersey2-useTags -maxdepth 1 -type f ! -name "README.md" -exec rm {} +
