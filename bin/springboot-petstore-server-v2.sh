...
ags="$@ generate -i modules/swagger-codegen/src/test/resources/3_0_0/petstore.yaml -l spring -o samples/server/petstore/springboot-v2 -DhideGenerationTimestamp=true --additional-properties java8=true,springBootVersion=2.1.7.RELEASE"
