...
ags="$@ generate -i modules/swagger-codegen/src/test/resources/2_0/fake-endpoints-v2/petstore.yaml  -l perl -o samples/client/petstore/perl -DhideGenerationTimestamp=true"
