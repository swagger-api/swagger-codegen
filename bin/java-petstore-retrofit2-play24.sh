...
ags="$@ generate -i modules/swagger-codegen/src/test/resources/2_0/fake-endpoints-v1/petstore.yaml -l java -c bin/java-petstore-retrofit2-play24.json -o samples/client/petstore/java/retrofit2-play24 -DhideGenerationTimestamp=true"
