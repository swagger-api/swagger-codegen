...
ags="$@ generate -i modules/swagger-codegen/src/test/resources/2_0/fake-endpoints-v1/petstore.yaml -l java -c bin/java-petstore-resteasy.json -o samples/client/petstore/java/resteasy -DhideGenerationTimestamp=true"
