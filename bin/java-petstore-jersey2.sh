...
ags="$@ generate -i modules/swagger-codegen/src/test/resources/2_0/fake-endpoints-v1/petstore.yaml -l java -c bin/java-petstore-jersey2.json -o samples/client/petstore/java/jersey2 -DhideGenerationTimestamp=true"
