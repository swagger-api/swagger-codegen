...
public class ClientConfiguration {
  ...
  @Value("${ swaggerPetstore.security.httpBasicTest.username:}")
  private String httpBasicTestUsername;

  @Value("${ swaggerPetstore.security.httpBasicTest.password:}")
  private String httpBasicTestPassword;

  @Bean
  @ConditionalOnProperty(name = "swaggerPetstore.security.httpBasicTest.username")
  public BasicAuthRequestInterceptor httpBasicTestRequestInterceptor() {
    return new BasicAuthRequestInterceptor(this.httpBasicTestUsername, this.httpBasicTestPassword);
  }
