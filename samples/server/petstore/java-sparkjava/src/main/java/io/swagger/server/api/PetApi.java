...
import java.io.File;
import io.swagger.server.models.ModelApiResponse;
import io.swagger.server.models.Pet;

public class PetApi {
        /* POST(/pet, addPet); //  */
        /* DELETE(/pet/{petId}, deletePet); //  */
        /* GET(/pet/findByStatus, findPetsByStatus); // List&lt;Pet&gt; */
        /* GET(/pet/findByTags, findPetsByTags); // List&lt;Pet&gt; */
        /* GET(/pet/{petId}, getPetById); // Pet */
        /* PUT(/pet, updatePet); //  */
        /* POST(/pet/{petId}, updatePetWithForm); //  */
        /* POST(/pet/{petId}/uploadImage, uploadFile); // ModelApiResponse */
}
