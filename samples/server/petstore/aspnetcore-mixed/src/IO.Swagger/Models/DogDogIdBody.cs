...
namespace IO.Swagger.Models
{
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DogDogIdBody)obj);
        }

        /// <summary>
        /// Returns true if DogDogIdBody instances are equal
        /// </summary>
        /// <param name="other">Instance of DogDogIdBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DogDogIdBody other)
        {
        ...
        public static bool operator ==(DogDogIdBody left, DogDogIdBody right)
        {
