...
namespace IO.Swagger.Models
{
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ModelReturn)obj);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (_Return != null)
                    hashCode = hashCode * 59 + _Return.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(ModelReturn left, ModelReturn right)
        {
