...
namespace IO.Swagger.Models
{
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ModelClient)obj);
        }
        ...
        public bool Equals(ModelClient other)
        {
            ...
            return 
                (
                    ...
                    __Client != null &&
                    __Client.Equals(other.__Client)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (__Client != null)
                    hashCode = hashCode * 59 + __Client.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(ModelClient left, ModelClient right)
        {
