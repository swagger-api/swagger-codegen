...
namespace IO.Swagger.Models
{
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PetIdUploadImageBody)obj);
        }

        /// <summary>
        /// Returns true if PetIdUploadImageBody instances are equal
        /// </summary>
        /// <param name="other">Instance of PetIdUploadImageBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PetIdUploadImageBody other)
        {
        ...
        public static bool operator ==(PetIdUploadImageBody left, PetIdUploadImageBody right)
        {
