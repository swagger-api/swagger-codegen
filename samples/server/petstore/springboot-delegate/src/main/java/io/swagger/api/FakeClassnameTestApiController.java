...
public class FakeClassnameTestApiController implements FakeClassnameTestApi {
    ...
    public ResponseEntity<Client> testClassname(@Parameter(in = ParameterIn.DEFAULT, description = "client model", required=true, schema=@Schema()) @Valid @RequestBody Client body) {
