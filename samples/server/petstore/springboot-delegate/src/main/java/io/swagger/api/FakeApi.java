...
public interface FakeApi {
    ...
    @RequestMapping(value = "/fake",
        ...
        method = RequestMethod.POST)
    ResponseEntity<Void> testEndpointParameters(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Body2 body);
...
, defaultValue="-efg")) @Valid @RequestParam(value = "enum_query_string", required = false, defaultValue="-efg") String enumQueryString, @Parameter(in = ParameterIn.QUERY, description = "Query parameter enum test (double)" ,schema=@Schema(allowableValues={ "1", "-2" }
    ...
    @RequestMapping(value = "/fake/enum/form",
        consumes = { "*/*" }, 
        method = RequestMethod.POST)
    ResponseEntity<Void> testEnumRequestBody(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody Body4 body);
    ...
    @RequestMapping(value = "/fake/jsonFormData",
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<Void> testJsonFormData(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Body5 body);
