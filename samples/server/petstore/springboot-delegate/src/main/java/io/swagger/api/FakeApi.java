...
public interface FakeApi {
    ...
    ResponseEntity<Boolean> fakeOuterBooleanSerialize(@Parameter(in = ParameterIn.DEFAULT, description = "Input boolean as post body", schema=@Schema()) @Valid @RequestBody Boolean body);
    ...
    @RequestMapping(value = "/fake/outer/composite",
        ...
        consumes = { "*/*" }, 
        method = RequestMethod.POST)
    ResponseEntity<OuterComposite> fakeOuterCompositeSerialize(@Parameter(in = ParameterIn.DEFAULT, description = "Input composite as post body", schema=@Schema()) @Valid @RequestBody OuterComposite body);
    ...
    @RequestMapping(value = "/fake/outer/number",
        ...
        consumes = { "*/*" }, 
        method = RequestMethod.POST)
    ResponseEntity<BigDecimal> fakeOuterNumberSerialize(@Parameter(in = ParameterIn.DEFAULT, description = "Input number as post body", schema=@Schema()) @Valid @RequestBody BigDecimal body);
    ...
    @RequestMapping(value = "/fake/outer/string",
        ...
        consumes = { "*/*" }, 
        method = RequestMethod.POST)
    ResponseEntity<String> fakeOuterStringSerialize(@Parameter(in = ParameterIn.DEFAULT, description = "Input string as post body", schema=@Schema()) @Valid @RequestBody String body);
    ...
    ResponseEntity<Client> testClientModel(@Parameter(in = ParameterIn.DEFAULT, description = "client model", required=true, schema=@Schema()) @Valid @RequestBody Client body);
    ...
    @RequestMapping(value = "/fake",
        ...
        method = RequestMethod.POST)
    ResponseEntity<Void> testEndpointParameters(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody FakeBody body);
    ...
    ResponseEntity<Void> testEnumParameters(@Parameter(in = ParameterIn.HEADER, description = "Header parameter enum test (string array)" ,schema=@Schema(allowableValues={ ">", "$" }
...
, defaultValue="-efg")) @Valid @RequestParam(value = "enum_query_string", required = false, defaultValue="-efg") String enumQueryString, @Parameter(in = ParameterIn.QUERY, description = "Query parameter enum test (double)" ,schema=@Schema(allowableValues={ "1", "-2" }
    ...
    @RequestMapping(value = "/fake/enum/form",
        consumes = { "*/*" }, 
        method = RequestMethod.POST)
    ResponseEntity<Void> testEnumRequestBody(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody EnumFormBody body);
    ...
    @RequestMapping(value = "/fake/inline-additionalProperties",
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<Void> testInlineAdditionalProperties(@Parameter(in = ParameterIn.DEFAULT, description = "request body", required=true, schema=@Schema()) @Valid @RequestBody Map<String, String> body);
    ...
    @RequestMapping(value = "/fake/jsonFormData",
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<Void> testJsonFormData(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody FakeJsonFormDataBody body);
