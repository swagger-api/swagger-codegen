...
public interface RandomPetApiDelegate {
     ...
     */
    default ResponseEntity<SinglePetResponse> getRandomPet() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default RandomPetApi interface so no example is generated");
        }
