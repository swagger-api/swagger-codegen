...
public interface AnotherFakeApi {
    ...
    default ResponseEntity<Client> testSpecialTags(@Parameter(in = ParameterIn.DEFAULT, description = "client model", required=true, schema=@Schema()) @Valid @RequestBody Client body) {
