...
,@ApiParam(value = "" ) @RequestHeader(value="api_key", required=false) String apiKey
    ...
    @RequestMapping(value = "/dog/{dogId}",
        ...
        method = RequestMethod.POST)
    default ResponseEntity<Void> updateDogWithForm(@ApiParam(value = "ID of dog that needs to be updated",required=true) @PathVariable("animalId") Long animalId
...
,@ApiParam(value = "") @RequestParam(value="status", required=false)  String status
        ...
        return getDelegate().updateDogWithForm(animalId, name, status);
    }
