...
public class FakeApiServiceImpl extends FakeApiService {
    ...
    @Override
    public Response testBodyWithQueryParams(User body,  @NotNull String query, SecurityContext securityContext)
    throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    ...
    @Override
    public Response testEndpointParameters(BigDecimal number, Double _double, String patternWithoutDelimiter, Integer integer, Integer int32, Long int64, Float _float, String string, Date date, Date dateTime, String password, String paramCallback, SecurityContext securityContext)
    throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
