...
public abstract class FakeApiService {
    ...
    public abstract Response testEndpointParameters(BigDecimal number,Double _double,String patternWithoutDelimiter,Integer integer,Integer int32,Long int64,Float _float,String string,Date date,Date dateTime,String password,String paramCallback,SecurityContext securityContext) throws NotFoundException;
