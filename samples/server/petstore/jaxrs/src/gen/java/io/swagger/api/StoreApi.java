...
public class StoreApi  {
   ...
   private final StoreApiService delegate = StoreApiServiceFactory.getStoreApi();
    ...
    @GET @Path("/inventory")  @Produces({ "application/json", "application/xml" })
    @io.swagger.annotations.ApiOperation(value = "Returns pet inventories by status", notes = "Returns a map of status codes to quantities", response = String, Integer.class, responseContainer = "Map")
    ...
    @GET @Path("/order/{orderId}")  @Produces({ "application/json", "application/xml" })
