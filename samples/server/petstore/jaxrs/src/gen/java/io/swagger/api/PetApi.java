...
public class PetApi  {
   ...
   private final PetApiService delegate = PetApiServiceFactory.getPetApi();
    ...
    @PUT  @Consumes({ "application/json", "application/xml" }) @Produces({ "application/json", "application/xml" })
    ...
    @POST  @Consumes({ "application/json", "application/xml" }) @Produces({ "application/json", "application/xml" })
    ...
    @GET @Path("/findByStatus")  @Produces({ "application/json", "application/xml" })
    ...
    @GET @Path("/findByTags")  @Produces({ "application/json", "application/xml" })
    ...
    @GET @Path("/{petId}")  @Produces({ "application/json", "application/xml" })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid ID supplied") })
    public Response getPetById(@ApiParam(value = "ID of pet that needs to be fetched",required=true, allowableValues="{}" ) @PathParam("petId") Long petId)
    throws NotFoundException {
        return delegate.getPetById(petId);
    }

    @POST @Path("/{petId}") @Consumes({ "application/x-www-form-urlencoded" }) @Produces({ "application/json", "application/xml" })
    ...
    public Response deletePet(@ApiParam(value = "Pet id to delete",required=true, allowableValues="{}" ) @PathParam("petId") Long petId,
    @ApiParam(value = ""  )@HeaderParam("api_key") String apiKey)
    throws NotFoundException {
        return delegate.deletePet(petId,apiKey);
    }

    @POST @Path("/{petId}/uploadImage") @Consumes({ "multipart/form-data" }) @Produces({ "application/json", "application/xml" })
    ...
    public Response uploadFile(@ApiParam(value = "ID of pet to update",required=true, allowableValues="{}" ) @PathParam("petId") Long petId,
