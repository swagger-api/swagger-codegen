...
public class UserApi  {
   ...
   private final UserApiService delegate = UserApiServiceFactory.getUserApi();
    ...
    @POST @Path("/createWithArray")  @Produces({ "application/json", "application/xml" })
    ...
    @POST @Path("/createWithList")  @Produces({ "application/json", "application/xml" })
    @io.swagger.annotations.ApiOperation(value = "Creates list of users with given input array", notes = "", response = Void.class)
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = Void.class) })
    ...
    @GET @Path("/login")  @Produces({ "application/json", "application/xml" })
    ...
    @GET @Path("/logout")  @Produces({ "application/json", "application/xml" })
    ...
    @GET @Path("/{username}")  @Produces({ "application/json", "application/xml" })
    ...
    @PUT @Path("/{username}")  @Produces({ "application/json", "application/xml" })
    ...
    @DELETE @Path("/{username}")  @Produces({ "application/json", "application/xml" })
