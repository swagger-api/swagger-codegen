...
public class StoreApi  {
   ...
   public StoreApi(@Context ServletConfig servletContext) {
    ...
    public Response deleteOrder(@Parameter(ParameterIn.PATH, description = "ID of the order that needs to be deleted",required=true) @PathParam("order_id") String orderId
,@Context SecurityContext securityContext)
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "404", description = "Order not found") })
    public Response getOrderById(@Parameter(ParameterIn.PATH, description = "ID of pet that needs to be fetched",required=true, schema=@Schema(allowableValues={  }, minimum="1", maximum="5")
...
,@Context SecurityContext securityContext)
    ...
    public Response placeOrder(@Parameter(ParameterIn.DEFAULT, description = "order placed for purchasing the pet" ,required=true) Order body
