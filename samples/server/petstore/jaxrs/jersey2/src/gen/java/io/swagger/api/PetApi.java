...
public class PetApi  {
   ...
   public PetApi(@Context ServletConfig servletContext) {
    ...
    public Response addPet(@Parameter(ParameterIn.DEFAULT, description = "Pet object that needs to be added to the store" ,required=true) Pet body
...
,@Context SecurityContext securityContext)
    ...
    public Response deletePet(@Parameter(ParameterIn.PATH, description = "Pet id to delete",required=true) @PathParam("petId") Long petId
,
@Parameter(ParameterIn.HEADER, description = "" )@HeaderParam("api_key") String apiKey
...
,@Context SecurityContext securityContext)
    ...
    public Response findPetsByStatus(@Parameter(ParameterIn.QUERY, description = "Status values that need to be considered for filter",required=true, schema=@Schema(allowableValues={ "available", "pending", "sold" })
...
,@Context SecurityContext securityContext)
    ...
    public Response findPetsByTags(@Parameter(ParameterIn.QUERY, description = "Tags to filter by",required=true) @QueryParam("tags") List<String> tags
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response getPetById(@Parameter(ParameterIn.PATH, description = "ID of pet to return",required=true) @PathParam("petId") Long petId
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response updatePet(@Parameter(ParameterIn.DEFAULT, description = "Pet object that needs to be added to the store" ,required=true) Pet body
...
,@Context SecurityContext securityContext)
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "405", description = "Invalid input") })
    public Response updatePetWithForm(@Parameter(ParameterIn.PATH, description = "ID of pet that needs to be updated",required=true) @PathParam("petId") Long petId
...
,@Context SecurityContext securityContext)
    ...
    public Response uploadFile(@Parameter(ParameterIn.PATH, description = "ID of pet to update",required=true) @PathParam("petId") Long petId
