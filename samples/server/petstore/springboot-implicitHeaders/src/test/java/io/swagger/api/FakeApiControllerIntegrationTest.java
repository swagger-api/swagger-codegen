...
private FakeApi api;
        ...
        public void testEnumParametersTest() throws Exception {
            ...
            ResponseEntity<Void> responseEntity = api.testEnumParameters(enumFormStringArray, enumFormString, enumQueryStringArray, enumQueryString, enumQueryInteger, enumQueryDouble);
            assertEquals(HttpStatus.NOT_IMPLEMENTED, responseEntity.getStatusCode());
        }
        @Test
