...
*/
public class FakePatchHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(FakePatchHandlerTest.class);

    @Test
    public void testFakePatchHandler() throws ClientException, ApiException {
