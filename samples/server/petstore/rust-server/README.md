...
- API version: 1.0.0
- Build date: 2017-11-20T15:09:15.826Z
...
<<<<<<< HEAD:samples/server/petstore/rust-server/README.md
=======
cargo run --example client GetXmlFeatures
cargo run --example client PostPlainText
cargo run --example client PostXmlFeatures
>>>>>>> 531e283... Added plaintext support:samples/client/petstore/rust2/README.md
