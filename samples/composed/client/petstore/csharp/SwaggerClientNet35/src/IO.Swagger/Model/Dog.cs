...
namespace IO.Swagger.Model
{
        ...
        public partial class Dog : Pet,  IEquatable<Dog>
    {
        ...
        public Dog(bool? bark = default(bool?), BreedEnum? breed = default(BreedEnum?), long? id = default(long?), string name = default(string), StatusEnum? status = default(StatusEnum?), List<Object> part = default(List<Object>)) : base(id, name, status, part)
        {
            this.Bark = bark;
            this.Breed = breed;
        }
