...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfSubCategoryPetsItems : Pet,  IEquatable<AllOfSubCategoryPetsItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfSubCategoryPetsItems" /> class.
        /// </summary>
        public AllOfSubCategoryPetsItems(long? id = default(long?), string name = default(string), StatusEnum? status = default(StatusEnum?), List<> part = default(List<>)) : base(id, name, status, part)
        {
        }
