...
namespace IO.Swagger.Model
{
        ...
        public partial class SubCategory :  IEquatable<SubCategory>
    {
        ...
        public SubCategory(AllOfSubCategoryCategory category = default(AllOfSubCategoryCategory), Category category2 = default(Category), List<SubCategoryPets> pets = default(List<SubCategoryPets>))
        {
