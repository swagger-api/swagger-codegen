...
export class StoreService {
     ...
     */
    public deleteOrder(orderId: number, extraHttpRequestParams?: RequestOptionsArgs): Observable<{}> {
     ...
     */
    public deleteOrderWithHttpInfo(orderId: number, extraHttpRequestParams?: RequestOptionsArgs): Observable<Response> {
