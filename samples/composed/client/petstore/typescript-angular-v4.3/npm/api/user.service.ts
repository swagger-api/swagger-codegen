...
export class UserService {
    ...
    public createUsersWithArrayInput(body: Array<User>, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/user/createWithArray`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public userUsernamePut(body: User, username: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public userUsernamePut(body: User, username: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public userUsernamePut(body: User, username: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public userUsernamePut(body: User, username: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling userUsernamePut.');
        }

        if (username === null || username === undefined) {
            throw new Error('Required parameter username was null or undefined when calling userUsernamePut.');
        }
