...
class UserApi
{
     ...
     * @return void
     */
    public function userUsernamePut($body, $username)
    {
        $this->userUsernamePutWithHttpInfo($body, $username);
    }

    /**
     * Operation userUsernamePutWithHttpInfo
     *
     * Updated user
     *
     * @param  \Swagger\Client\Model\User $body Updated user object (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function userUsernamePutWithHttpInfo($body, $username)
    {
        $returnType = '';
        $request = $this->userUsernamePutRequest($body, $username);
    ...
    /**
     * Operation userUsernamePutAsync
     *
     * Updated user
     *
     * @param  \Swagger\Client\Model\User $body Updated user object (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userUsernamePutAsync($body, $username)
    {
        return $this->userUsernamePutAsyncWithHttpInfo($body, $username)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation userUsernamePutAsyncWithHttpInfo
     *
     * Updated user
     *
     * @param  \Swagger\Client\Model\User $body Updated user object (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userUsernamePutAsyncWithHttpInfo($body, $username)
    {
        $returnType = '';
        $request = $this->userUsernamePutRequest($body, $username);
    ...
    /**
     * Create request for operation 'userUsernamePut'
     *
     * @param  \Swagger\Client\Model\User $body Updated user object (required)
     * @param  string $username name that need to be updated (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userUsernamePutRequest($body, $username)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling userUsernamePut'
            );
        }
        // verify the required parameter 'username' is set
        if ($username === null || (is_array($username) && count($username) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $username when calling userUsernamePut'
            );
        }
