...
class PetApi
{
     ...
     * @return void
     */
    public function feedPet($body, $token, $pet_type, $status, $pet_id)
    {
        $this->feedPetWithHttpInfo($body, $token, $pet_type, $status, $pet_id);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function feedPetWithHttpInfo($body, $token, $pet_type, $status, $pet_id)
    {
        $returnType = '';
        $request = $this->feedPetRequest($body, $token, $pet_type, $status, $pet_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function feedPetAsync($body, $token, $pet_type, $status, $pet_id)
    {
        return $this->feedPetAsyncWithHttpInfo($body, $token, $pet_type, $status, $pet_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function feedPetAsyncWithHttpInfo($body, $token, $pet_type, $status, $pet_id)
    {
        $returnType = '';
        $request = $this->feedPetRequest($body, $token, $pet_type, $status, $pet_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function feedPetRequest($body, $token, $pet_type, $status, $pet_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
