...
class PetApi
{
     ...
     */
    public function addParrot($body = null)
    {
        list($response) = $this->addParrotWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation addParrotWithHttpInfo
     *
     * Add a new parrow to the store
     *
     ...
     */
    public function addParrotWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2001';
        $request = $this->addParrotRequest($body);
     ...
     */
    public function addParrotAsync($body = null)
    {
        return $this->addParrotAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addParrotAsyncWithHttpInfo
     *
     * Add a new parrow to the store
     *
     * @param  \Swagger\Client\Model\Body2 $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addParrotAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2001';
        $request = $this->addParrotRequest($body);
    ...
    /**
     * Create request for operation 'addParrot'
     *
     * @param  \Swagger\Client\Model\Body2 $body (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function addParrotRequest($body = null)
    {
     ...
     *
     * @param  \Swagger\Client\Model\Pet $body Pet object that needs to be added to the store (required)
     * @param  string $token status (required)
     * @param  string $pet_type type of food (required)
     ...
     * @return void
     */
    public function feedPet($body, $token, $pet_type, $status, $pet_id, $session_id)
    {
        $this->feedPetWithHttpInfo($body, $token, $pet_type, $status, $pet_id, $session_id);
    }

    /**
     * Operation feedPetWithHttpInfo
     *
     * Find pet by ID
     *
     * @param  \Swagger\Client\Model\Pet $body Pet object that needs to be added to the store (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function feedPetWithHttpInfo($body, $token, $pet_type, $status, $pet_id, $session_id)
    {
        $returnType = '';
        $request = $this->feedPetRequest($body, $token, $pet_type, $status, $pet_id, $session_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function feedPetAsync($body, $token, $pet_type, $status, $pet_id, $session_id)
    {
        return $this->feedPetAsyncWithHttpInfo($body, $token, $pet_type, $status, $pet_id, $session_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation feedPetAsyncWithHttpInfo
     *
     * Find pet by ID
     *
     * @param  \Swagger\Client\Model\Pet $body Pet object that needs to be added to the store (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function feedPetAsyncWithHttpInfo($body, $token, $pet_type, $status, $pet_id, $session_id)
    {
        $returnType = '';
        $request = $this->feedPetRequest($body, $token, $pet_type, $status, $pet_id, $session_id);
    ...
    /**
     * Create request for operation 'feedPet'
     *
     * @param  \Swagger\Client\Model\Pet $body Pet object that needs to be added to the store (required)
     * @param  string $token status (required)
     * @param  string $pet_type type of food (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function feedPetRequest($body, $token, $pet_type, $status, $pet_id, $session_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling feedPet'
            );
        }
        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling feedPet'
            );
        }
        // verify the required parameter 'pet_type' is set
        if ($pet_type === null || (is_array($pet_type) && count($pet_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pet_type when calling feedPet'
            );
        }
        // verify the required parameter 'status' is set
        if ($status === null || (is_array($status) && count($status) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $status when calling feedPet'
            );
        }
        // verify the required parameter 'pet_id' is set
        if ($pet_id === null || (is_array($pet_id) && count($pet_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pet_id when calling feedPet'
            );
        }
        // verify the required parameter 'session_id' is set
        if ($session_id === null || (is_array($session_id) && count($session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $session_id when calling feedPet'
            );
        }

        $resourcePath = '/pet/feed/{petId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($pet_type !== null) {
            $queryParams['petType'] = ObjectSerializer::toQueryValue($pet_type);
        }
        // query params
        if ($status !== null) {
     ...
     * @return null[]
     */
    public function getParrots()
    {
        list($response) = $this->getParrotsWithHttpInfo();
        return $response;
    }

    /**
     * Operation getParrotsWithHttpInfo
     *
     * get Parrots
     *
     *
     ...
     * @return array of null[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getParrotsWithHttpInfo()
    {
        $returnType = 'null[]';
        $request = $this->getParrotsRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getParrotsAsync()
    {
        return $this->getParrotsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getParrotsAsyncWithHttpInfo
     *
     * get Parrots
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getParrotsAsyncWithHttpInfo()
    {
        $returnType = 'null[]';
        $request = $this->getParrotsRequest();
    ...
    /**
     * Create request for operation 'getParrots'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getParrotsRequest()
    {
     ...
     */
    public function updateParrots($body = null)
    {
        list($response) = $this->updateParrotsWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation updateParrotsWithHttpInfo
     *
     * update parrots
     *
     ...
     */
    public function updateParrotsWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->updateParrotsRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateParrotsAsync($body = null)
    {
        return $this->updateParrotsAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateParrotsAsyncWithHttpInfo
     *
     * update parrots
     *
     * @param  \Swagger\Client\Model\Body1 $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateParrotsAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->updateParrotsRequest($body);
    ...
    /**
     * Create request for operation 'updateParrots'
     *
     * @param  \Swagger\Client\Model\Body1 $body (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateParrotsRequest($body = null)
    {
     ...
     */
    public function uploadFile($pet_id, $body = null)
    {
        list($response) = $this->uploadFileWithHttpInfo($pet_id, $body);
        return $response;
    }
     ...
     */
    public function uploadFileWithHttpInfo($pet_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ApiResponse';
        $request = $this->uploadFileRequest($pet_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileAsync($pet_id, $body = null)
    {
        return $this->uploadFileAsyncWithHttpInfo($pet_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileAsyncWithHttpInfo($pet_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ApiResponse';
        $request = $this->uploadFileRequest($pet_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadFileRequest($pet_id, $body = null)
    {
        // verify the required parameter 'pet_id' is set
        if ($pet_id === null || (is_array($pet_id) && count($pet_id) === 0)) {
            throw new \InvalidArgumentException(
