...
public class ValMemberChoice2 implements Parcelable {
  @SerializedName("val_leaving_date")
  private LocalDate valLeavingDate = null;

  public ValMemberChoice2() {
  }
  ...
  **/
  ...
  public static final Parcelable.Creator<ValMemberChoice2> CREATOR = new Parcelable.Creator<ValMemberChoice2>() {
    public ValMemberChoice2 createFromParcel(Parcel in) {
      return new ValMemberChoice2(in);
    }
    public ValMemberChoice2[] newArray(int size) {
      return new ValMemberChoice2[size];
    }
  };
}
