...
public class PetApi {
    ...
    public List<InlineResponseItems200> getParrots() throws ApiException {
        ApiResponse<List<InlineResponseItems200>> resp = getParrotsWithHttpInfo();
        return resp.getData();
    }
     ...
     * get Parrots
     * 
     * @return ApiResponse&lt;List&lt;InlineResponseItems200&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<InlineResponseItems200>> getParrotsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getParrotsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<List<InlineResponseItems200>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getParrotsAsync(final ApiCallback<List<InlineResponseItems200>> callback) throws ApiException {
