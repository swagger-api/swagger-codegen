...
public class ValMembers implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    out.writeValue(valMember);
  }

  ValMembers(Parcel in) {
    valMember = (List<Object>)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<ValMembers> CREATOR = new Parcelable.Creator<ValMembers>() {
    public ValMembers createFromParcel(Parcel in) {
      return new ValMembers(in);
    }
    public ValMembers[] newArray(int size) {
      return new ValMembers[size];
    }
  };
}
