...
public class Macaw implements Parcelable , AnyOfbody2, OneOfinlineResponse2001 {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(singer);
  }

  Macaw(Parcel in) {
    color = (String)in.readValue(null);
    singer = (Boolean)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<Macaw> CREATOR = new Parcelable.Creator<Macaw>() {
    public Macaw createFromParcel(Parcel in) {
      return new Macaw(in);
    }
    public Macaw[] newArray(int size) {
      return new Macaw[size];
    }
  };
}
