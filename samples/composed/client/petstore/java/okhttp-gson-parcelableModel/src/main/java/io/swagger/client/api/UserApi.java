...
public class UserApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call userUsernamePutCall(User body, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call userUsernamePutValidateBeforeCall(User body, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling userUsernamePut(Async)");
        }
        // verify the required parameter 'username' is set
        if (username == null) {
        ...
        com.squareup.okhttp.Call call = userUsernamePutCall(body, username, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> userUsernamePutWithHttpInfo(User body, String username) throws ApiException {
        com.squareup.okhttp.Call call = userUsernamePutValidateBeforeCall(body, username, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call userUsernamePutAsync(User body, String username, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = userUsernamePutValidateBeforeCall(body, username, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
