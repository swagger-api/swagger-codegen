...
public class ValMemberChoice1 implements Parcelable , OneOfvalMembersValMemberItems {
  @SerializedName("val_date_of_birth")
  private LocalDate valDateOfBirth = null;

  @SerializedName("val_leaving_date")
  private LocalDate valLeavingDate = null;

  public ValMemberChoice1() {
  }
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    out.writeValue(valDateOfBirth);
    out.writeValue(valLeavingDate);
  }

  ValMemberChoice1(Parcel in) {
    valDateOfBirth = (LocalDate)in.readValue(LocalDate.class.getClassLoader());
    valLeavingDate = (LocalDate)in.readValue(LocalDate.class.getClassLoader());
  }
  ...
  public static final Parcelable.Creator<ValMemberChoice1> CREATOR = new Parcelable.Creator<ValMemberChoice1>() {
    public ValMemberChoice1 createFromParcel(Parcel in) {
      return new ValMemberChoice1(in);
    }
    public ValMemberChoice1[] newArray(int size) {
      return new ValMemberChoice1[size];
    }
  };
}
