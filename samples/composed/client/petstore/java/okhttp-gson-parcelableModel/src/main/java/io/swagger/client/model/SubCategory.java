...
import io.swagger.client.model.SubCategoryPets;
...
public class SubCategory implements Parcelable {
  ...
  **/
  ...
  public SubCategory addPetsItem(SubCategoryPets petsItem) {
    if (this.pets == null) {
      this.pets = new ArrayList<SubCategoryPets>();
    }
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(category2);
    out.writeValue(pets);
  }

  SubCategory(Parcel in) {
    category = (AllOfSubCategoryCategory)in.readValue(null);
    category2 = (Category)in.readValue(Category.class.getClassLoader());
    pets = (List<SubCategoryPets>)in.readValue(SubCategoryPets.class.getClassLoader());
  }
