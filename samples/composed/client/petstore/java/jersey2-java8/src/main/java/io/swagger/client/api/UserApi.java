...
public class UserApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public void userUsernamePut(User body, String username) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling userUsernamePut");
    }
    // verify the required parameter 'username' is set
    if (username == null) {
