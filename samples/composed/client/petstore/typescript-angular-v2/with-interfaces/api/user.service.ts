...
export class UserService implements UserServiceInterface {
     ...
     */
    public userUsernamePut(body: User, username: string, extraHttpRequestParams?: RequestOptionsArgs): Observable<{}> {
        return this.userUsernamePutWithHttpInfo(body, username, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public userUsernamePutWithHttpInfo(body: User, username: string, extraHttpRequestParams?: RequestOptionsArgs): Observable<Response> {
