...
,@ApiParam(value = "" ) @RequestHeader(value="api_key", required=false) String apiKey
    ...
    @ApiOperation(value = "Find pet by ID", nickname = "feedPet", notes = "schedule pet feeding", tags={ "pet", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation") })
    @RequestMapping(value = "/pet/feed/{petId}",
        consumes = { "application/json", "application/xml" },
        method = RequestMethod.POST)
    default ResponseEntity<Void> feedPet(@ApiParam(value = "Pet object that needs to be added to the store" ,required=true )  @Valid @RequestBody Pet body
...
,@ApiParam(value = "session id" ,required=true) @CookieValue(value="sessionId", required=true) String sessionId
        ...
        return getDelegate().feedPet(body, token, petType, status, petId, sessionId);
    }
...
,@ApiParam(value = ""  )  @Valid @RequestBody Object body
        ...
        return getDelegate().uploadFile(petId, body);
    }
