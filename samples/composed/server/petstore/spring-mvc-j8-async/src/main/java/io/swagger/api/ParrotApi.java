...
public interface ParrotApi {
    ...
    default CompletableFuture<ResponseEntity<InlineResponse2001>> addParrot(@ApiParam(value = ""  )  @Valid @RequestBody Body2 body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return CompletableFuture.completedFuture(new ResponseEntity<>(getObjectMapper().get().readValue("\"\"", InlineResponse2001.class), HttpStatus.NOT_IMPLEMENTED));
                } catch (IOException e) {
    ...
    default CompletableFuture<ResponseEntity<List<Object>>> getParrots() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
    ...
    default CompletableFuture<ResponseEntity<InlineResponse200>> updateParrots(@ApiParam(value = ""  )  @Valid @RequestBody Body1 body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
