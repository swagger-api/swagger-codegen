...
import io.swagger.model.SubCategoryPets;
...
public class SubCategory   {
  ...
  @JsonProperty("pets")
  private List<SubCategoryPets> pets = null;
  /**
   **/
  ...
  /**
   **/
  public SubCategory pets(List<SubCategoryPets> pets) {
    this.pets = pets;
    return this;
  }
  ...
  @Schema(description = "")
  @JsonProperty("pets")
  public List<SubCategoryPets> getPets() {
    return pets;
  }
  public void setPets(List<SubCategoryPets> pets) {
    this.pets = pets;
  }
