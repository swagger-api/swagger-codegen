...
{ 
    ...
    { 
        ...
        /// <response code="200">successful operation</response>
        IActionResult FeedPet([FromBody]Pet body, [FromHeader][Required()]string token, [FromQuery][Required()]string petType, [FromQuery][Required()]string status, [FromRoute][Required]long? petId);
