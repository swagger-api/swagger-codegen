...
{ 
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ValMembers)obj);
        }

        /// <summary>
        /// Returns true if ValMembers instances are equal
        /// </summary>
        /// <param name="other">Instance of ValMembers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValMembers other)
        {
            ...
            return 
                (
                    ValMember == other.ValMember ||
                    ValMember != null &&
                    ValMember.SequenceEqual(other.ValMember)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (ValMember != null)
                    hashCode = hashCode * 59 + ValMember.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(ValMembers left, ValMembers right)
        {
