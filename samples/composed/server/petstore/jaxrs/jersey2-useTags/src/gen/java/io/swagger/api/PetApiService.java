...
public abstract class PetApiService {
    public abstract Response addParrot(Body2 body,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response feedPet(Pet body,String token, @NotNull String petType, @NotNull String status,Long petId,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response updateParrots(Body1 body,SecurityContext securityContext) throws NotFoundException;
