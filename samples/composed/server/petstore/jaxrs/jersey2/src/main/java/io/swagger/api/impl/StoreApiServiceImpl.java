...
public class StoreApiServiceImpl extends StoreApiService {
    @Override
    public Response deleteOrder( @Min(1L)Long orderId, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
    ...
    @Override
    public Response getOrderById( @Min(1L) @Max(10L)Long orderId, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
