...
@Parameter(description = "Pet object that needs to be added to the store" ,required=true) Pet body
, 
@Parameter(description = "status" ,required=true)@HeaderParam("token") String token
,  @NotNull 
@Parameter(description = "type of food",required=true)  @QueryParam("petType") String petType
,  @NotNull 
