...
public interface PetApi {
    ...
    @ApiImplicitParams({
    @ApiImplicitParam(name = "token", value = "status", required=true, dataType = "String", paramType = "header")    })
    @RequestMapping(value = "/pet/feed/{petId}",
        consumes = { "application/json", "application/xml" },
        method = RequestMethod.POST)
    ResponseEntity<Void> feedPet(@ApiParam(value = "Pet object that needs to be added to the store" ,required=true )  @Valid @RequestBody Pet body
