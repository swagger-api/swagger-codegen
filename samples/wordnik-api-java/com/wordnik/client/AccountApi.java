...
public class AccountApi {
  ...
  public List<WordList> getWordListsForCurrentUser (String auth_token, int skip, int limit) throws ApiException {
    // create path and map variables
  ...
  public User getLoggedInUser (String api_key, String auth_token) throws ApiException {
    // create path and map variables
    ...
    // verify required params are set
    if(api_key == null || auth_token == null ) {
       throw new ApiException(400, "missing required params");
    }
    headerParams.put("api_key", api_key);
    headerParams.put("auth_token", auth_token);
