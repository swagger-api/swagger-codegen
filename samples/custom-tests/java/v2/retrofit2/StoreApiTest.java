...
public class StoreApiTest {
    ...
    public void setup() {
        ...
        api = apiClient.createService(StoreApi.class);
    ...
    public void getInventoryTest() throws Exception {
        Call<Map<String, Integer>> callResponse = api.getInventory();
        Map<String, Integer> response = callResponse.execute().body();
    ...
    public void getOrderByIdTest() throws Exception {
        Long orderId = 10L;
        Call<Order> callResponse = api.getOrderById(orderId);
        Order response = callResponse.execute().body();
    ...
    public void placeOrderTest() throws Exception {
        Order body = new Order().id(10L)
                ...
                .quantity(1);
        Call<Order> callResponse = api.placeOrder(body);
        Order response = callResponse.execute().body();
