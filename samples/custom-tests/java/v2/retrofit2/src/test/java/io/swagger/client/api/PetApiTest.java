...
public class PetApiTest {
    ...
    public void findPetsByStatusTest() throws Exception {
        ...
        Call<List<Pet>> callResponse = api.findPetsByStatus(status);

        List<Pet> response = callResponse.execute().body();
    ...
    public void getPetByIdTest() throws Exception {
        Long petId = 10L;
        Call<Pet> callResponse = api.getPetById(petId);

        Pet response = callResponse.execute().body();
