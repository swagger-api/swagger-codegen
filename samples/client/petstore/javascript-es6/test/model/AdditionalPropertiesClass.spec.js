...
(function(root, factory) {
  ...
  describe('AdditionalPropertiesClass', function() {
    ...
    it('should have the property map_property (base name: "map_property")', function() {
      // uncomment below and update the code to test the property map_property
      //var instane = new SwaggerPetstore.AdditionalPropertiesClass();
      //expect(instance).to.be();
    });

    it('should have the property map_of_map_property (base name: "map_of_map_property")', function() {
      // uncomment below and update the code to test the property map_of_map_property
      //var instane = new SwaggerPetstore.AdditionalPropertiesClass();
      //expect(instance).to.be();
    });
