...
(function(root, factory) {
  ...
  describe('SpecialModelName', function() {
    ...
    it('should have the property special_property_name (base name: "$special[property.name]")', function() {
      // uncomment below and update the code to test the property special_property_name
      //var instane = new SwaggerPetstore.SpecialModelName();
