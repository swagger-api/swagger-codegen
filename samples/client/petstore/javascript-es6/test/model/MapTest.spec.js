...
(function(root, factory) {
  ...
  describe('MapTest', function() {
    ...
    it('should have the property map_map_of_string (base name: "map_map_of_string")', function() {
      // uncomment below and update the code to test the property map_map_of_string
      //var instane = new SwaggerPetstore.MapTest();
      //expect(instance).to.be();
    });

    it('should have the property map_of_enum_string (base name: "map_of_enum_string")', function() {
      // uncomment below and update the code to test the property map_of_enum_string
      //var instane = new SwaggerPetstore.MapTest();
      //expect(instance).to.be();
    });
