...
public interface UserApi {
    ...
    @ApiOperation(value = "Updated user", nickname = "userUsernamePut", notes = "This can only be done by the logged in user.", tags={ "user", })
    @ApiResponses(value = { 
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> userUsernamePut(@ApiParam(value = "name that need to be updated", required=true) @PathVariable("username") String username, @ApiParam(value = "Updated user object", required=true ) @Valid @RequestBody User body);
