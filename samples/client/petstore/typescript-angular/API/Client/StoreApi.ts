...
namespace API.Client {
    ...
    export class StoreApi {
         ...
         */
        public getInventory (extraHttpRequestParams?: ng.IRequestShortcutConfig ) : ng.IHttpPromise<{ [key: string]: number; }> {
         ...
         */
        public getOrderById (orderId: string, extraHttpRequestParams?: ng.IRequestShortcutConfig ) : ng.IHttpPromise<Order> {
            const localVarPath = this.basePath + '/store/order/{orderId}'
                .replace('{' + 'orderId' + '}', String(orderId));
         ...
         */
        public placeOrder (body?: Order, extraHttpRequestParams?: ng.IRequestShortcutConfig ) : ng.IHttpPromise<Order> {
