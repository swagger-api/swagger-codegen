...
namespace IO.Swagger.Model
{
    ...
    public partial class Capitalization :  IEquatable<Capitalization>, IValidatableObject
    {
        ...
        /// <summary>
        /// Deserialize the JSON string into a <see cref="Capitalization" /> object.
        /// </summary>
        /// <param name="json">JSON string.</param>
        /// <returns>Object representation of the JSON string.</returns>
        public static Capitalization FromJson(string json)
        {
            return JsonConvert.DeserializeObject<Capitalization>(json);
        }
