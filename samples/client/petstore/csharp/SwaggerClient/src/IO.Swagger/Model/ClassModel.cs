...
namespace IO.Swagger.Model
{
    ...
    public partial class ClassModel :  IEquatable<ClassModel>, IValidatableObject
    {
        ...
        /// <summary>
        /// Deserialize the JSON string into a <see cref="ClassModel" /> object.
        /// </summary>
        /// <param name="json">JSON string.</param>
        /// <returns>Object representation of the JSON string.</returns>
        public static ClassModel FromJson(string json)
        {
            return JsonConvert.DeserializeObject<ClassModel>(json);
        }
