...
namespace IO.Swagger.Model
{
        ...
        public partial class Body2 :  IEquatable<Body2>, IValidatableObject
    {
        ...
        public Body2(int? integer = default(int?), int? int32 = default(int?), long? int64 = default(long?), decimal? number = default(decimal?), float? _float = default(float?), double? _double = default(double?), string _string = default(string), string patternWithoutDelimiter = default(string), byte[] _byte = default(byte[]), byte[] binary = default(byte[]), DateTime? date = default(DateTime?), DateTime? dateTime = default(DateTime?), string password = default(string), string callback = default(string))
        {
            ...
            if (_double == null)
            {
                throw new InvalidDataException("_double is a required property for Body2 and cannot be null");
            }
            else
            {
                this.Double = _double;
            ...
            {
                throw new InvalidDataException("patternWithoutDelimiter is a required property for Body2 and cannot be null");
            }
            else
            {
            ...
            if (_byte == null)
            {
                throw new InvalidDataException("_byte is a required property for Body2 and cannot be null");
            }
            else
            {
                this.Byte = _byte;
