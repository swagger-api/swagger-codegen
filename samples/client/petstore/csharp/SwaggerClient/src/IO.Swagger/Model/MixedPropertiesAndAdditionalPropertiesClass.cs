...
namespace IO.Swagger.Model
{
    ...
    public partial class MixedPropertiesAndAdditionalPropertiesClass :  IEquatable<MixedPropertiesAndAdditionalPropertiesClass>, IValidatableObject
    {
        ...
        public MixedPropertiesAndAdditionalPropertiesClass(Guid? Uuid = default(Guid?), DateTime? DateTime = default(DateTime?), Dictionary<string, IO.Swagger.Model.Animal> Map = default(Dictionary<string, IO.Swagger.Model.Animal>))
        {
            this.Uuid = Uuid;
        ...
        public Dictionary<string, IO.Swagger.Model.Animal> Map { get; set; }
