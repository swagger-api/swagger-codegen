...
namespace IO.Swagger.Model
{
    ...
    public partial class MixedPropertiesAndAdditionalPropertiesClass :  IEquatable<MixedPropertiesAndAdditionalPropertiesClass>, IValidatableObject
    {
        ...
        /// <summary>
        /// Deserialize the JSON string into a <see cref="MixedPropertiesAndAdditionalPropertiesClass" /> object.
        /// </summary>
        /// <param name="json">JSON string.</param>
        /// <returns>Object representation of the JSON string.</returns>
        public static MixedPropertiesAndAdditionalPropertiesClass FromJson(string json)
        {
            return JsonConvert.DeserializeObject<MixedPropertiesAndAdditionalPropertiesClass>(json);
        }
