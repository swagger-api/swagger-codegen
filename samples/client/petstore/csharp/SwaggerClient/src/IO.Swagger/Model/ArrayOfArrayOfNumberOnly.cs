...
namespace IO.Swagger.Model
{
    ...
    public partial class ArrayOfArrayOfNumberOnly :  IEquatable<ArrayOfArrayOfNumberOnly>, IValidatableObject
    {
        ...
        /// <summary>
        /// Deserialize the JSON string into a <see cref="ArrayOfArrayOfNumberOnly" /> object.
        /// </summary>
        /// <param name="json">JSON string.</param>
        /// <returns>Object representation of the JSON string.</returns>
        public static ArrayOfArrayOfNumberOnly FromJson(string json)
        {
            return JsonConvert.DeserializeObject<ArrayOfArrayOfNumberOnly>(json);
        }
