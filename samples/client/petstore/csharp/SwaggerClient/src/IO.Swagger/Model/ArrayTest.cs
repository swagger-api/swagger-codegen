...
namespace IO.Swagger.Model
{
    ...
    public partial class ArrayTest :  IEquatable<ArrayTest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Deserialize the JSON string into a <see cref="ArrayTest" /> object.
        /// </summary>
        /// <param name="json">JSON string.</param>
        /// <returns>Object representation of the JSON string.</returns>
        public static ArrayTest FromJson(string json)
        {
            return JsonConvert.DeserializeObject<ArrayTest>(json);
        }
