...
namespace IO.Swagger.Model
{
    ...
    public partial class ModelClient :  IEquatable<ModelClient>, IValidatableObject
    {
        ...
        /// <summary>
        /// Deserialize the JSON string into a <see cref="ModelClient" /> object.
        /// </summary>
        /// <param name="json">JSON string.</param>
        /// <returns>Object representation of the JSON string.</returns>
        public static ModelClient FromJson(string json)
        {
            return JsonConvert.DeserializeObject<ModelClient>(json);
        }
