...
namespace IO.Swagger.Model
{
    ...
    public partial class HasOnlyReadOnly :  IEquatable<HasOnlyReadOnly>, IValidatableObject
    {
        ...
        /// <summary>
        /// Deserialize the JSON string into a <see cref="HasOnlyReadOnly" /> object.
        /// </summary>
        /// <param name="json">JSON string.</param>
        /// <returns>Object representation of the JSON string.</returns>
        public static HasOnlyReadOnly FromJson(string json)
        {
            return JsonConvert.DeserializeObject<HasOnlyReadOnly>(json);
        }
