...
namespace IO.Swagger.Model
{
    ...
    public partial class AnimalFarm : List<Animal>,  IEquatable<AnimalFarm>, IValidatableObject
    {
        ...
        /// <summary>
        /// Deserialize the JSON string into a <see cref="AnimalFarm" /> object.
        /// </summary>
        /// <param name="json">JSON string.</param>
        /// <returns>Object representation of the JSON string.</returns>
        public static AnimalFarm FromJson(string json)
        {
            return JsonConvert.DeserializeObject<AnimalFarm>(json);
        }
