...
namespace IO.Swagger.Model
{
    ...
    public partial class SpecialModelName :  IEquatable<SpecialModelName>, IValidatableObject
    {
        ...
        /// <summary>
        /// Deserialize the JSON string into a <see cref="SpecialModelName" /> object.
        /// </summary>
        /// <param name="json">JSON string.</param>
        /// <returns>Object representation of the JSON string.</returns>
        public static SpecialModelName FromJson(string json)
        {
            return JsonConvert.DeserializeObject<SpecialModelName>(json);
        }
