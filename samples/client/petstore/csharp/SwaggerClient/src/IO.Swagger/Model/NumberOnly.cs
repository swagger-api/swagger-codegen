...
namespace IO.Swagger.Model
{
    ...
    public partial class NumberOnly :  IEquatable<NumberOnly>, IValidatableObject
    {
        ...
        /// <summary>
        /// Deserialize the JSON string into a <see cref="NumberOnly" /> object.
        /// </summary>
        /// <param name="json">JSON string.</param>
        /// <returns>Object representation of the JSON string.</returns>
        public static NumberOnly FromJson(string json)
        {
            return JsonConvert.DeserializeObject<NumberOnly>(json);
        }
