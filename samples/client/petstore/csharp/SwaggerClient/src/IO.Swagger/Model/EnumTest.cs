...
namespace IO.Swagger.Model
{
    ...
    public partial class EnumTest :  IEquatable<EnumTest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Deserialize the JSON string into a <see cref="EnumTest" /> object.
        /// </summary>
        /// <param name="json">JSON string.</param>
        /// <returns>Object representation of the JSON string.</returns>
        public static EnumTest FromJson(string json)
        {
            return JsonConvert.DeserializeObject<EnumTest>(json);
        }
