...
namespace IO.Swagger.Model
{
    ...
    public partial class Configuration :  IEquatable<Configuration>
    {
        ...
        /// </summary>
        /// <param name="_Configuration">_Configuration.</param>
        public Configuration(string _Configuration = null)
        {
        ...
        public bool Equals(Configuration other)
        {
            ...
            return 
                (
                    ...
                    this._Configuration.Equals(other._Configuration)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Configuration != null)
                    hash = hash * 59 + this._Configuration.GetHashCode();
                return hash;
            }
        }
    }
