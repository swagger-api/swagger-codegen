...
namespace IO.Swagger.Api
{
    ...
    public interface IFake_classname_tags123Api : IApiAccessor
    {
        ...
        /// <param name="body">client model (optional)</param>
        /// <returns>ApiResponse of ModelClient</returns>
        ApiResponse<ModelClient> TestClassname_0WithHttpInfo (ModelClient body = null);
        ...
        /// <param name="body">client model (optional)</param>
        /// <returns>Task of ModelClient</returns>
        System.Threading.Tasks.Task<ModelClient> TestClassname_0Async (ModelClient body = null);
        ...
        /// <param name="body">client model (optional)</param>
        /// <returns>Task of ApiResponse (ModelClient)</returns>
        System.Threading.Tasks.Task<ApiResponse<ModelClient>> TestClassname_0AsyncWithHttpInfo (ModelClient body = null);
    ...
    public partial class Fake_classname_tags123Api : IFake_classname_tags123Api
    {
        ...
        /// <param name="body">client model (optional)</param>
        /// <returns>ModelClient</returns>
        public ModelClient TestClassname_0 (ModelClient body = null)
        {
             ApiResponse<ModelClient> localVarResponse = TestClassname_0WithHttpInfo(body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body">client model (optional)</param>
        /// <returns>ApiResponse of ModelClient</returns>
        public ApiResponse< ModelClient > TestClassname_0WithHttpInfo (ModelClient body = null)
        {

            var localVarPath = "/fake_classname_test_optional";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("TestClassname_0", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="body">client model (optional)</param>
        /// <returns>Task of ModelClient</returns>
        public async System.Threading.Tasks.Task<ModelClient> TestClassname_0Async (ModelClient body = null)
        {
             ApiResponse<ModelClient> localVarResponse = await TestClassname_0AsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body">client model (optional)</param>
        /// <returns>Task of ApiResponse (ModelClient)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ModelClient>> TestClassname_0AsyncWithHttpInfo (ModelClient body = null)
        {
