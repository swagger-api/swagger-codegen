...
copy packages\Newtonsoft.Json.10.0.3\libnet40\Newtonsoft.Json.dll bin\Newtonsoft.Json.dll
copy packages\JsonSubTypes.1.2.0\libnet40\JsonSubTypes.dll bin\JsonSubTypes.dll
copy packages\RestSharp.105.1.0\libnet4\RestSharp.dll bin\RestSharp.dll
