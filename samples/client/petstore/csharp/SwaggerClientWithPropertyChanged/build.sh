...
cp packages/PropertyChanged.Fody.1.53.0/PropertyChanged.Fody.dll bin/PropertyChanged.Fody.dll
cp packages/PropertyChanged.Fody.1.53.0/Lib/dotnet/PropertyChanged.dll bin/PropertyChanged.dll
