...
val apiInstance = ApiClient().createService(PetApi::class.java)
val body : Pet =  // Pet | Pet object that needs to be added to the store
val result = apiInstance.addPet(body).execute()
```
...
val result = apiInstance.deletePet(petId, apiKey).execute()
```
...
val result = apiInstance.findPetsByStatus(status).execute()
println(result.body())
```
...
val result = apiInstance.findPetsByTags(tags).execute()
println(result.body())
```
...
val result = apiInstance.getPetById(petId).execute()
println(result.body())
```
...
val apiInstance = ApiClient().createService(PetApi::class.java)
val body : Pet =  // Pet | Pet object that needs to be added to the store
val result = apiInstance.updatePet(body).execute()
```
...
val result = apiInstance.updatePetWithForm(petId, name, status).execute()
```
...
val result = apiInstance.uploadFile(petId, additionalMetadata, file).execute()
println(result.body())
```
