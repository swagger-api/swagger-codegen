...
*Fake_classname_tags123Api* | [**testClassname_0**](docs/Api/Fake_classname_tags123Api.md#testclassname_0) | **PATCH** /fake_classname_test_optional | To test class name in snake case
