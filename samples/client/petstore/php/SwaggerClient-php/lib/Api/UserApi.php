...
class UserApi
{
     ...
     * @return void
     */
    public function updateUser($body, $username)
    {
        $this->updateUserWithHttpInfo($body, $username);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateUserWithHttpInfo($body, $username)
    {
        $returnType = '';
        $request = $this->updateUserRequest($body, $username);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateUserAsync($body, $username)
    {
        return $this->updateUserAsyncWithHttpInfo($body, $username)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateUserAsyncWithHttpInfo($body, $username)
    {
        $returnType = '';
        $request = $this->updateUserRequest($body, $username);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateUserRequest($body, $username)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
