...
class Fake_classname_tags123Api
{
    ...
    /**
     * Operation testClassname_0
     *
     * To test class name in snake case
     *
     * @param \Swagger\Client\Model\Client $body client model (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\Client
     */
    public function testClassname_0($body = null)
    {
        list($response) = $this->testClassname_0WithHttpInfo($body);
        return $response;
    }

    /**
     * Operation testClassname_0WithHttpInfo
     *
     * To test class name in snake case
     *
     * @param \Swagger\Client\Model\Client $body client model (optional)
     ...
     * @return array of \Swagger\Client\Model\Client, HTTP status code, HTTP response headers (array of strings)
     */
    public function testClassname_0WithHttpInfo($body = null)
    {
        // parse inputs
        $resourcePath = "/fake_classname_test_optional";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
