...
impl Api for Client {
    fn fake_outer_boolean_serialize(
        ...
        context: &Context,
    ) -> Box<Future<Item = FakeOuterBooleanSerializeResponse, Error = ApiError> + Send> {
        ...
        context.x_span_id.as_ref().map(|header| {
            custom_headers.set(XSpanId(header.clone()))
        });
    ...
    fn fake_outer_composite_serialize(
        ...
        context: &Context,
    ) -> Box<Future<Item = FakeOuterCompositeSerializeResponse, Error = ApiError> + Send> {
    ...
    fn fake_outer_number_serialize(
        ...
        context: &Context,
    ) -> Box<Future<Item = FakeOuterNumberSerializeResponse, Error = ApiError> + Send> {
    ...
    fn fake_outer_string_serialize(
        ...
        context: &Context,
    ) -> Box<Future<Item = FakeOuterStringSerializeResponse, Error = ApiError> + Send> {
    ...
    fn test_client_model(
        ...
        context: &Context,
    ) -> Box<Future<Item = TestClientModelResponse, Error = ApiError> + Send> {
        ...
        let request = self.hyper_client.request(
    ...
    fn test_endpoint_parameters(
        ...
        context: &Context,
    ) -> Box<Future<Item = TestEndpointParametersResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                400 => Ok(TestEndpointParametersResponse::InvalidUsernameSupplied),
                404 => Ok(TestEndpointParametersResponse::UserNotFound),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn test_enum_parameters(
        &self,
        param_enum_form_string_array: Option<&Vec<String>>,
        ...
        context: &Context,
    ) -> Box<Future<Item = TestEnumParametersResponse, Error = ApiError> + Send> {

        // Query parameters
        let query_enum_query_string_array =
            param_enum_query_string_array.map_or_else(String::new, |query| {
                format!(
                    "enum_query_string_array={enum_query_string_array}&",
                    enum_query_string_array = query.join(",")
                )
            });
        let query_enum_query_string = param_enum_query_string.map_or_else(String::new, |query| {
            format!(
                "enum_query_string={enum_query_string}&",
                enum_query_string = query.to_string()
            )
        });
        let query_enum_query_integer = param_enum_query_integer.map_or_else(String::new, |query| {
            format!(
                "enum_query_integer={enum_query_integer}&",
                enum_query_integer = query.to_string()
            )
        });
        ...
        let url = format!(
            ...
            self.base_path,
            enum_query_string_array = query_enum_query_string_array,
            enum_query_string = query_enum_query_string,
            enum_query_integer = query_enum_query_integer
        );
        ...
        param_enum_header_string_array.map(|header| {
            custom_headers.set(RequestEnumHeaderStringArray(header.clone()))
        });
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                400 => Ok(TestEnumParametersResponse::InvalidRequest),
                404 => Ok(TestEnumParametersResponse::NotFound),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn test_json_form_data(
        ...
        param_param2: String,
        context: &Context,
    ) -> Box<Future<Item = TestJsonFormDataResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                200 => Ok(TestJsonFormDataResponse::SuccessfulOperation),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn test_classname(
        ...
        param_body: models::Client,
        context: &Context,
    ) -> Box<Future<Item = TestClassnameResponse, Error = ApiError> + Send> {
    ...
    fn add_pet(
        ...
        context: &Context,
    ) -> Box<Future<Item = AddPetResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                405 => Ok(AddPetResponse::InvalidInput),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn delete_pet(
        ...
        context: &Context,
    ) -> Box<Future<Item = DeletePetResponse, Error = ApiError> + Send> {


        let url = format!(
            "{}/v2/pet/{petId}?",
            self.base_path,
            petId = param_pet_id.to_string()
        );
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                400 => Ok(DeletePetResponse::InvalidPetValue),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn find_pets_by_status(
        ...
        context: &Context,
    ) -> Box<Future<Item = FindPetsByStatusResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                ...
                400 => Ok(FindPetsByStatusResponse::InvalidStatusValue),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn find_pets_by_tags(
        ...
        context: &Context,
    ) -> Box<Future<Item = FindPetsByTagsResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                ...
                400 => Ok(FindPetsByTagsResponse::InvalidTagValue),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn get_pet_by_id(
        ...
        param_pet_id: i64,
        context: &Context,
    ) -> Box<Future<Item = GetPetByIdResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                ...
                400 => Ok(GetPetByIdResponse::InvalidIDSupplied),
                404 => Ok(GetPetByIdResponse::PetNotFound),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn update_pet(
        ...
        param_body: models::Pet,
        context: &Context,
    ) -> Box<Future<Item = UpdatePetResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                400 => Ok(UpdatePetResponse::InvalidIDSupplied),
                404 => Ok(UpdatePetResponse::PetNotFound),
                405 => Ok(UpdatePetResponse::ValidationException),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn update_pet_with_form(
        ...
        context: &Context,
    ) -> Box<Future<Item = UpdatePetWithFormResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                405 => Ok(UpdatePetWithFormResponse::InvalidInput),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn upload_file(
        ...
        param_file: Box<
            Future<
                Item = Option<Box<Stream<Item = Vec<u8>, Error = Error> + Send>>,
                Error = Error,
            >
                + Send,
        >,
        context: &Context,
    ) -> Box<Future<Item = UploadFileResponse, Error = ApiError> + Send> {
        ...
        let mut fields = match multipart.prepare() {
            Ok(fields) => fields,
            Err(err) => {
                return Box::new(futures::done(
                    Err(ApiError(format!("Unable to build request: {}", err))),
                ))
            }
        };
        ...
        let request = request.headers(custom_headers);
        let request = request.header(ContentType(multipart_header)).body(
            &body_string,
        );
            ...
            stream
                ...
                .and_then(|body| {
                    String::from_utf8(body).map_err(|e| {
                        ApiError(format!("Failed to convert utf8 stream to String: {}", e))
                    })
                })
        }
    ...
    fn delete_order(
        ...
        context: &Context,
    ) -> Box<Future<Item = DeleteOrderResponse, Error = ApiError> + Send> {


        let url = format!(
            "{}/v2/store/order/{order_id}?",
            self.base_path,
            order_id = param_order_id.to_string()
        );
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                400 => Ok(DeleteOrderResponse::InvalidIDSupplied),
                404 => Ok(DeleteOrderResponse::OrderNotFound),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn get_inventory(
        &self,
        context: &Context,
    ) -> Box<Future<Item = GetInventoryResponse, Error = ApiError> + Send> {
    ...
    fn get_order_by_id(
        ...
        param_order_id: i64,
        context: &Context,
    ) -> Box<Future<Item = GetOrderByIdResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                ...
                400 => Ok(GetOrderByIdResponse::InvalidIDSupplied),
                404 => Ok(GetOrderByIdResponse::OrderNotFound),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn place_order(
        ...
        context: &Context,
    ) -> Box<Future<Item = PlaceOrderResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                ...
                400 => Ok(PlaceOrderResponse::InvalidOrder),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn create_user(
        ...
        context: &Context,
    ) -> Box<Future<Item = CreateUserResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                0 => Ok(CreateUserResponse::SuccessfulOperation),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn create_users_with_array_input(
        ...
        context: &Context,
    ) -> Box<Future<Item = CreateUsersWithArrayInputResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                0 => Ok(CreateUsersWithArrayInputResponse::SuccessfulOperation),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn create_users_with_list_input(
        ...
        param_body: &Vec<models::User>,
        context: &Context,
    ) -> Box<Future<Item = CreateUsersWithListInputResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                0 => Ok(CreateUsersWithListInputResponse::SuccessfulOperation),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn delete_user(
        ...
        context: &Context,
    ) -> Box<Future<Item = DeleteUserResponse, Error = ApiError> + Send> {


        let url = format!(
            "{}/v2/user/{username}?",
            self.base_path,
            username = param_username.to_string()
        );
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                400 => Ok(DeleteUserResponse::InvalidUsernameSupplied),
                404 => Ok(DeleteUserResponse::UserNotFound),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn get_user_by_name(
        ...
        param_username: String,
        context: &Context,
    ) -> Box<Future<Item = GetUserByNameResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                ...
                400 => Ok(GetUserByNameResponse::InvalidUsernameSupplied),
                404 => Ok(GetUserByNameResponse::UserNotFound),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn login_user(
        ...
        context: &Context,
    ) -> Box<Future<Item = LoginUserResponse, Error = ApiError> + Send> {

        // Query parameters
        let query_username = format!(
            "username={username}&",
            username = param_username.to_string()
        );
        let query_password = format!(
            "password={password}&",
            password = param_password.to_string()
        );
            ...
            match response.status.to_u16() {
                200 => {
                    ...
                    Ok(LoginUserResponse::SuccessfulOperation {
                        body: body,
                        x_rate_limit: response_x_rate_limit.0.clone(),
                        x_expires_after: response_x_expires_after.0.clone(),
                    })
                }
                400 => Ok(LoginUserResponse::InvalidUsername),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn logout_user(
        &self,
        context: &Context,
    ) -> Box<Future<Item = LogoutUserResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                0 => Ok(LogoutUserResponse::SuccessfulOperation),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
    ...
    fn update_user(
        ...
        param_body: models::User,
        context: &Context,
    ) -> Box<Future<Item = UpdateUserResponse, Error = ApiError> + Send> {
        ...
        fn parse_response(
            ...
            match response.status.to_u16() {
                400 => Ok(UpdateUserResponse::InvalidUserSupplied),
                404 => Ok(UpdateUserResponse::UserNotFound),
                code => Err(ApiError(format!("Unexpected response code: {}", code))),
            }
        }
