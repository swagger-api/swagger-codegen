...
#[allow(unused_imports)]
use petstore_api::{Api, ApiError, FakeOuterBooleanSerializeResponse,
...
fn main() {
    ...
    let client = if matches.is_present("https") {
        // Using Simple HTTPS
        petstore_api::Client::try_new_https("https://localhost:8080", "examples/ca.pem")
            .expect("Failed to create HTTPS client")
    } else {
        // Using HTTP
        petstore_api::Client::try_new_http("http://localhost:8080")
    ...
    match matches.value_of("operation") {
        ...
        Some("FakeOuterBooleanSerialize") => {
            ...
            let context =
                petstore_api::Context::new_with_span_id(self::uuid::Uuid::new_v4().to_string());
        ...
        Some("TestEndpointParameters") => {
            ...
            let result = client
                .test_endpoint_parameters(
                    ...
                    swagger::ByteArray("byte_example".to_string().into_bytes()),
                    Some(56),
                    Some(56),
                    Some(789),
                    Some(3.4),
                    Some("string_example".to_string()),
                    Some(swagger::ByteArray(Vec::from("B"))),
                    None,
                    None,
        ...
        Some("DeletePet") => {
            ...
            let context =
                petstore_api::Context::new_with_span_id(self::uuid::Uuid::new_v4().to_string());
            let result = client
                .delete_pet(789, Some("api_key_example".to_string()), &context)
                .wait();
            println!(
                "{:?} (X-Span-ID: {:?})",
                result,
        ...
        Some("UploadFile") => {
            ...
            let result = client
                .upload_file(
                    ...
                    Box::new(future::ok(
                        Some(Box::new(stream::once(Ok(b"hello".to_vec()))) as
                            Box<Stream<Item = _, Error = _> + Send>),
        ...
        Some("DeleteOrder") => {
            ...
            let context =
                petstore_api::Context::new_with_span_id(self::uuid::Uuid::new_v4().to_string());
            let result = client
                .delete_order("order_id_example".to_string(), &context)
                .wait();
            println!(
                "{:?} (X-Span-ID: {:?})",
                result,
        ...
        Some("CreateUsersWithArrayInput") => {
            ...
            let context =
                petstore_api::Context::new_with_span_id(self::uuid::Uuid::new_v4().to_string());
            let result = client
                .create_users_with_array_input(&Vec::new(), &context)
                .wait();
            println!(
                "{:?} (X-Span-ID: {:?})",
                result,
        ...
        Some("CreateUsersWithListInput") => {
            ...
            let context =
                petstore_api::Context::new_with_span_id(self::uuid::Uuid::new_v4().to_string());
            let result = client
                .create_users_with_list_input(&Vec::new(), &context)
                .wait();
            println!(
                "{:?} (X-Span-ID: {:?})",
                result,
        ...
        Some("DeleteUser") => {
            ...
            let context =
                petstore_api::Context::new_with_span_id(self::uuid::Uuid::new_v4().to_string());
            let result = client
                .delete_user("username_example".to_string(), &context)
                .wait();
            println!(
                "{:?} (X-Span-ID: {:?})",
                result,
        ...
        Some("GetUserByName") => {
            ...
            let context =
                petstore_api::Context::new_with_span_id(self::uuid::Uuid::new_v4().to_string());
            let result = client
                .get_user_by_name("username_example".to_string(), &context)
                .wait();
            println!(
                "{:?} (X-Span-ID: {:?})",
                result,
