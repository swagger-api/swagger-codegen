...
import { AllPetsResponse } from '../models';
import { ApiResponse } from '../models';
import { Pet } from '../models';
import { SinglePetResponse } from '../models';
...
export const PetApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        doCategoryStuff: async (body?: SubCategory, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        findPetsByStatus: async (status: Array<string>, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getAllPets: async (options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getRandomPet: async (options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        uploadFile: async (petId: number, additionalMetadata?: string, file?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'petId' is not null or undefined
            if (petId === null || petId === undefined) {
...
export const PetApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async doCategoryStuff(body?: SubCategory, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponse>> {
            const localVarAxiosArgs = await PetApiAxiosParamCreator(configuration).doCategoryStuff(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async findPetsByStatus(status: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Pet>>> {
         ...
         * @throws {RequiredError}
         */
        async getAllPets(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AllPetsResponse>> {
            const localVarAxiosArgs = await PetApiAxiosParamCreator(configuration).getAllPets(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getRandomPet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SinglePetResponse>> {
            const localVarAxiosArgs = await PetApiAxiosParamCreator(configuration).getRandomPet(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async uploadFile(petId: number, additionalMetadata?: string, file?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponse>> {
...
export const PetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        doCategoryStuff(body?: SubCategory, options?: any): AxiosPromise<ApiResponse> {
            return PetApiFp(configuration).doCategoryStuff(body, options).then((request) => request(axios, basePath));
        },
        /**
         * Multiple status values can be provided with comma separated strings
         * @summary Finds Pets by status
         ...
         * @throws {RequiredError}
         */
        getAllPets(options?: any): AxiosPromise<AllPetsResponse> {
            return PetApiFp(configuration).getAllPets(options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a single pet
         * @summary Find pet by ID
         ...
         * @throws {RequiredError}
         */
        getRandomPet(options?: any): AxiosPromise<SinglePetResponse> {
            return PetApiFp(configuration).getRandomPet(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update an existing pet
         ...
         * @throws {RequiredError}
         */
        uploadFile(petId: number, additionalMetadata?: string, file?: string, options?: any): AxiosPromise<ApiResponse> {
...
export class PetApi extends BaseAPI {
    ...
    public doCategoryStuff(body?: SubCategory, options?: any) {
        return PetApiFp(this.configuration).doCategoryStuff(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Multiple status values can be provided with comma separated strings
     * @summary Finds Pets by status
    ...
    public getAllPets(options?: any) {
        return PetApiFp(this.configuration).getAllPets(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a single pet
     * @summary Find pet by ID
    ...
    public getRandomPet(options?: any) {
        return PetApiFp(this.configuration).getRandomPet(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Update an existing pet
     ...
     * @memberof PetApi
     */
    public uploadFile(petId: number, additionalMetadata?: string, file?: string, options?: any) {
