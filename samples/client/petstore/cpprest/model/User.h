...
public:
    ...
    utility::string_t* getNewusernameInstance();
    ...
    utility::string_t* getNewfirstNameInstance();
    ...
    utility::string_t* getNewlastNameInstance();
    ...
    utility::string_t* getNewemailInstance();
    ...
    utility::string_t* getNewpasswordInstance();
    ...
    utility::string_t* getNewphoneInstance();
    ...
    int32_t* getNewuserStatusInstance();
