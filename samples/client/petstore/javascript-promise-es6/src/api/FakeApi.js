...
export default class FakeApi {
    ...
    */
     ...
     */
    testEndpointParametersWithHttpInfo(_number, _double, pattern_without_delimiter, _byte, opts) {
      opts = opts || {};
      let postBody = null;
    ...
    testEnumParametersWithHttpInfo(opts) {
      ...
      let queryParams = {
        'enum_query_string_array': this.apiClient.buildCollectionParam(opts['enum_query_string_array'], 'csv'),
