...
class PetApi(object):
    ...
    def do_category_stuff(self, **kwargs):  # noqa: E501
        """do_category_stuff  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_category_stuff(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.do_category_stuff_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.do_category_stuff_with_http_info(**kwargs)  # noqa: E501
            return data

    def do_category_stuff_with_http_info(self, **kwargs):  # noqa: E501
        """do_category_stuff  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_category_stuff_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method do_category_stuff" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_all_pets(self, **kwargs):  # noqa: E501
        """get_all_pets  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_pets(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_pets_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_pets_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_pets_with_http_info(self, **kwargs):  # noqa: E501
        """get_all_pets  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_pets_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='AllPetsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_random_pet(self, **kwargs):  # noqa: E501
        """get_random_pet  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_random_pet(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_random_pet_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_random_pet_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_random_pet_with_http_info(self, **kwargs):  # noqa: E501
        """get_random_pet  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_random_pet_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SinglePetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
