...
class MapTest(object):
    ...
    def __init__(self, map_map_of_string=None, map_of_enum_string=None,_configuration=None):  # noqa: E501
    ...
    def map_of_enum_string(self, map_of_enum_string):
        ...
        if self._configuration.client_side_validation and not set(map_of_enum_string.keys()).issubset(set(allowed_values)):
            raise ValueError(
