...
class MapTest(object):
    ...
    def __init__(self, map_map_of_string=None, map_of_enum_string=None,swagger_codegen_config=None):  # noqa: E501
    ...
    def map_of_enum_string(self, map_of_enum_string):
        ...
        if self.swagger_codegen_config.client_side_validation and not set(map_of_enum_string.keys()).issubset(set(allowed_values)):
            raise ValueError(
