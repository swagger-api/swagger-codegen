...
class User(object):
    ...
    def __init__(self, id=None, username=None, first_name=None, last_name=None, email=None, password=None, phone=None, user_status=None,swagger_codegen_config=None):  # noqa: E501
