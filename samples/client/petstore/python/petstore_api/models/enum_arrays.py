...
class EnumArrays(object):
    ...
    def __init__(self, just_symbol=None, array_enum=None,swagger_codegen_config=None):  # noqa: E501
    ...
    def just_symbol(self, just_symbol):
        ...
        if self.swagger_codegen_config.client_side_validation and just_symbol not in allowed_values:
            raise ValueError(
    ...
    def array_enum(self, array_enum):
        ...
        if self.swagger_codegen_config.client_side_validation and not set(array_enum).issubset(set(allowed_values)):
            raise ValueError(
