...
class Pet(object):
    ...
    def __init__(self, id=None, category=None, name=None, photo_urls=None, tags=None, status=None,swagger_codegen_config=None):  # noqa: E501
    ...
    def name(self, name):
        ...
        :type: str
        """
        if self.swagger_codegen_config.client_side_validation and name is None:
    ...
    def photo_urls(self, photo_urls):
        ...
        :type: list[str]
        """
        if self.swagger_codegen_config.client_side_validation and photo_urls is None:
    ...
    def status(self, status):
        ...
        if self.swagger_codegen_config.client_side_validation and status not in allowed_values:
            raise ValueError(
