...
class EnumTest(object):
    ...
    def enum_string(self, enum_string):
        ...
        if self._configuration.client_side_validation and enum_string not in allowed_values:
            raise ValueError(
    ...
    def enum_string_required(self, enum_string_required):
        ...
        allowed_values = ["UPPER", "lower", ""]  # noqa: E501
        if self._configuration.client_side_validation and enum_string_required not in allowed_values:
            raise ValueError(
    ...
    def enum_integer(self, enum_integer):
        ...
        if self._configuration.client_side_validation and enum_integer not in allowed_values:
            raise ValueError(
    ...
    def enum_number(self, enum_number):
        ...
        if self._configuration.client_side_validation and enum_number not in allowed_values:
            raise ValueError(
