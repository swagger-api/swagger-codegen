...
class EnumTest(object):
    ...
    def __init__(self, enum_string=None, enum_string_required=None, enum_integer=None, enum_number=None, outer_enum=None,swagger_codegen_config=None):  # noqa: E501
    ...
    def enum_string(self, enum_string):
        ...
        if self.swagger_codegen_config.client_side_validation and enum_string not in allowed_values:
            raise ValueError(
    ...
    def enum_string_required(self, enum_string_required):
        ...
        :type: str
        """
        if self.swagger_codegen_config.client_side_validation and enum_string_required is None:
            raise ValueError("Invalid value for `enum_string_required`, must not be `None`")  # noqa: E501
        allowed_values = ["UPPER", "lower", ""]  # noqa: E501
        if self.swagger_codegen_config.client_side_validation and enum_string_required not in allowed_values:
            raise ValueError(
    ...
    def enum_integer(self, enum_integer):
        ...
        if self.swagger_codegen_config.client_side_validation and enum_integer not in allowed_values:
            raise ValueError(
    ...
    def enum_number(self, enum_number):
        ...
        if self.swagger_codegen_config.client_side_validation and enum_number not in allowed_values:
            raise ValueError(
