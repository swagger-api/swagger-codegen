  ...
  describe('(package)', function() {
    describe('SpecialModelName', function() {
      ...
      it('should create an instance of SpecialModelName', function() {
        // TODO: update the code to test SpecialModelName
      ...
      it('should have the property specialPropertyName (base name: "$special[property.name]")', function() {
        // TODO: update the code to test the property specialPropertyName
        expect(instance).to.have.property('specialPropertyName');
        // expect(instance.specialPropertyName).to.be(expectedValueLiteral);
      });
