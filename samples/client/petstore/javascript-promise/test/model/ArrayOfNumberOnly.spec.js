  ...
  describe('(package)', function() {
    describe('ArrayOfNumberOnly', function() {
      ...
      it('should create an instance of ArrayOfNumberOnly', function() {
        // TODO: update the code to test ArrayOfNumberOnly
      ...
      it('should have the property arrayNumber (base name: "ArrayNumber")', function() {
        // TODO: update the code to test the property arrayNumber
        expect(instance).to.have.property('arrayNumber');
        // expect(instance.arrayNumber).to.be(expectedValueLiteral);
      });
