...
(function(root, factory) {
  ...
  describe('Fake_classname_tags123Api', function() {
    ...
    describe('testClassname_0', function() {
      it('should call testClassname_0 successfully', function(done) {
        //uncomment below and update the code to test testClassname_0
        //instance.testClassname_0(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
