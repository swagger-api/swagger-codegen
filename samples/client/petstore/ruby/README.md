...
*Petstore::FakeClassnameTags123Api* | [**test_classname_0**](docs/FakeClassnameTags123Api.md#test_classname_0) | **PATCH** /fake_classname_test_optional | To test class name in snake case
