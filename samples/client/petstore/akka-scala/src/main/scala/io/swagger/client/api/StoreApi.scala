...
object StoreApi {
   ...
   */
    def apply(orderId: String): ApiRequest[Unit] =
   ...
   *   api_key (apiKey)
   */
    def apply()(implicit apiKey: ApiKeyValue): ApiRequest[Map[String, Int]] =
   ...
   */
    def apply(orderId: Long): ApiRequest[Order] =
   ...
   */
    def apply(body: Order): ApiRequest[Order] =
