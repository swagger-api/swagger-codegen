...
object UserApi {
   ...
   */
    def apply(body: User): ApiRequest[Unit] =
   ...
   */
    def apply(body: Seq[User]): ApiRequest[Unit] =
   ...
   */
    def apply(username: String): ApiRequest[Unit] =
   ...
   */
    def apply(username: String): ApiRequest[User] =
   ...
   */
    def apply(username: String, password: String): ApiRequest[String] =
   ...
   */
    def apply(username: String, body: User): ApiRequest[Unit] =
