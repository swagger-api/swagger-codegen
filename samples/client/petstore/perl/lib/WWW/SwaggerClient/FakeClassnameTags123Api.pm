...
# To test class name in snake case
# 
# @param Client $body client model (optional)
{
    my $params = {
    'body' => {
        data_type => 'Client',
    ...
    __PACKAGE__->method_documentation->{ 'test_classname_0' } = { 
    	summary => 'To test class name in snake case',
        params => $params,
        returns => 'Client',
        };
...
# @return Client
#
sub test_classname_0 {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/fake_classname_test_optional';
    $_resource_path =~ s/{format}/json/; # default format to json
