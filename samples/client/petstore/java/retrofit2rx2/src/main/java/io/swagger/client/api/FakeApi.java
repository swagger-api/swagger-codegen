...
public interface FakeApi {
  ...
  @POST("fake")
  Observable<Response<Void>> testEndpointParameters(
  ...
  @retrofit2.http.FormUrlEncoded
  @GET("fake")
  Observable<Response<Void>> testEnumParameters(
  ...
  Observable<Response<Void>> testInlineAdditionalProperties(
  ...
  Observable<Response<Void>> testJsonFormData(
