...
@XmlRootElement(name = "ObjectWithFloatEnum")
@XmlAccessorType(XmlAccessType.FIELD)
@JacksonXmlRootElement(localName = "ObjectWithFloatEnum")
public class ObjectWithFloatEnum {
  ...
  // items.example= items.type=Float
  ...
  // items.example= items.type=FloatEnum
