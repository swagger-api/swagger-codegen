...
@XmlRootElement(name = "ObjectWithLongEnum")
@XmlAccessorType(XmlAccessType.FIELD)
@JacksonXmlRootElement(localName = "ObjectWithLongEnum")
public class ObjectWithLongEnum {
  ...
  // items.example= items.type=LongEnum
