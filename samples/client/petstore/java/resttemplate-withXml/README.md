# swagger-pestore-resttemplate-withxml
...
```groovy
compile "io.swagger:swagger-pestore-resttemplate-withxml:1.0.0"
```
...
* target/swagger-pestore-resttemplate-withxml-1.0.0.jar
* target/lib/*.jar
