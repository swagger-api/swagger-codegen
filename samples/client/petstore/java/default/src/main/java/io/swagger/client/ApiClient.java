...
public class ApiClient {
    ...
    /**
     * Returns the current object mapper used for JSON serialization/deserialization. <p> Note: If
     * you make changes to the object mapper, remember to set it back via
     * <code>setObjectMapper</code> in order to trigger HTTP client rebuilding. </p>
     */
    ...
    /**
     * Set the connect timeout (in milliseconds). A value of 0 means no timeout, otherwise values
