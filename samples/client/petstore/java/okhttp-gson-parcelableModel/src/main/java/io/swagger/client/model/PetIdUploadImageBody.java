...
public class PetIdUploadImageBody implements Parcelable {
  ...
  **/
  ...
  PetIdUploadImageBody(Parcel in) {
  ...
  public static final Parcelable.Creator<PetIdUploadImageBody> CREATOR = new Parcelable.Creator<PetIdUploadImageBody>() {
    public PetIdUploadImageBody createFromParcel(Parcel in) {
      return new PetIdUploadImageBody(in);
    }
    public PetIdUploadImageBody[] newArray(int size) {
      return new PetIdUploadImageBody[size];
    }
  };
}
