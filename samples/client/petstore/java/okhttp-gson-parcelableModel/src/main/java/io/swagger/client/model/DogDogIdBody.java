...
public class DogDogIdBody implements Parcelable {
  @SerializedName("name")
  ...
  **/
  ...
  public static final Parcelable.Creator<DogDogIdBody> CREATOR = new Parcelable.Creator<DogDogIdBody>() {
    public DogDogIdBody createFromParcel(Parcel in) {
      return new DogDogIdBody(in);
    }
    public DogDogIdBody[] newArray(int size) {
      return new DogDogIdBody[size];
    }
  };
}
