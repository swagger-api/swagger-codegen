...
public class PetPetIdBody implements Parcelable {
  @SerializedName("name")
  ...
  **/
  ...
  public static final Parcelable.Creator<PetPetIdBody> CREATOR = new Parcelable.Creator<PetPetIdBody>() {
    public PetPetIdBody createFromParcel(Parcel in) {
      return new PetPetIdBody(in);
    }
    public PetPetIdBody[] newArray(int size) {
      return new PetPetIdBody[size];
    }
  };
}
