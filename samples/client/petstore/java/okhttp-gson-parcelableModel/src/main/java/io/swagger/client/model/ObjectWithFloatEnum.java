...
public class ObjectWithFloatEnum implements Parcelable {
  /**
  ...
  **/
  ...
  public ObjectWithFloatEnum() {
    super();
  }

  ObjectWithFloatEnum(Parcel in) {
    
    innerEnum = (InnerEnumEnum)in.readValue(null);
    arrayWithInnerEnum = (List<ArrayWithInnerEnumEnum>)in.readValue(null);
    arrayWithOuterEnum = (List<FloatEnum>)in.readValue(FloatEnum.class.getClassLoader());
  }
  ...
  public static final Parcelable.Creator<ObjectWithFloatEnum> CREATOR = new Parcelable.Creator<ObjectWithFloatEnum>() {
    public ObjectWithFloatEnum createFromParcel(Parcel in) {
      return new ObjectWithFloatEnum(in);
    }
    public ObjectWithFloatEnum[] newArray(int size) {
      return new ObjectWithFloatEnum[size];
    }
  };
}
