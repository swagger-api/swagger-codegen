 ...
 */
public class PlayCallFactory implements okhttp3.Call.Factory {
    ...
    public PlayCallFactory(WSClient wsClient) {
        this.wsClient = wsClient;
    }

    public PlayCallFactory(WSClient wsClient, List<WSRequestFilter> filters) {
        this(wsClient);
        this.filters.addAll(filters);
    }

    public PlayCallFactory(WSClient wsClient, Map<String, String> extraHeaders,
