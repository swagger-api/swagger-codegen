lazy val root = (project in file(".")).
  settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.fasterxml.jackson.core" % "jackson-core" % "2.8.0" % "compile",
      "com.fasterxml.jackson.core" % "jackson-annotations" % "2.8.0" % "compile",
      "com.fasterxml.jackson.core" % "jackson-databind" % "2.8.0" % "compile",
      "com.fasterxml.jackson.datatype" % "jackson-datatype-joda" % "2.8.0" % "compile",
