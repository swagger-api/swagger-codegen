...
public class UserApi {
    ...
    /**
     * Create user (asynchronously) This can only be done by the logged in user.
     *
     * @param body     Created user object (required)
    ...
    /**
     * Delete user (asynchronously) This can only be done by the logged in user.
     *
     * @param username The name that needs to be deleted (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Updated user (asynchronously) This can only be done by the logged in user.
     *
     * @param username name that need to be deleted (required)
     * @param body     Updated user object (required)
     * @param callback The callback to be executed when the API call finishes
