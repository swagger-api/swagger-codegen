...
public class StoreApi {
    ...
    /**
     * Delete purchase order by ID (asynchronously) For valid response try integer IDs with value
    ...
    public ApiResponse<Map<String, Integer>> getInventoryWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<Map<String, Integer>>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Returns pet inventories by status (asynchronously) Returns a map of status codes to
     * quantities
     *
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Find purchase order by ID (asynchronously) For valid response try integer IDs with value
