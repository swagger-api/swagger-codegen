...
public class ApiClient {
  ...
  */
    ...
    if (contentType.startsWith("application/json")) {
      try {
        ...
        if (returnType.equals(String.class))
          ...
          return (T) parseDateOrDatetime(respBody);
        else throw(e);
      }
    } else {
   ...
   */
  public Call buildCall(String path, String method, List<Pair> queryParams, Object body, Map<String, Object> headerParams, Map<String, Object> formParams, String[] authNames) throws ApiException {
   ...
   * @param authNames The authentications to apply
   */
  public void updateParamsForAuth(String[] authNames, List<Pair> queryParams, Map<String, Object> headerParams) {
