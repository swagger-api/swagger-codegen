...
public interface AnimalApi {
  ...
  @POST("animal")
  F.Promise<Response<Void>> addAnimal(
  ...
  F.Promise<Response<Void>> deleteAnimal(
   ...
   */
  @GET("animal/{animalId}")
  F.Promise<Response<Animal>> getAnimalById(
  ...
  @PUT("animal")
  F.Promise<Response<Void>> updateAnimal(
    @retrofit2.http.Body Animal body
  );
  ...
  F.Promise<Response<Void>> updateAnimalWithForm(
