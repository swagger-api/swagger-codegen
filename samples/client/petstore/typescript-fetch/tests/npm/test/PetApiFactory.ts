  ...
  function runSuite(description: string, requestOptions?: any): void {
    ...
    describe(description, () => {
      ...
      it('should add and delete Pet', () => {
        return PetApiFactory().addPet(fixture, requestOptions).then(() => {
        });
      });

      it('should get Pet by ID', () => {
          return PetApiFactory().getPetById(fixture.id, requestOptions).then((result) => {
      ...
      it('should update Pet by ID', () => {
        return PetApiFactory().getPetById(fixture.id, requestOptions).then( (result) => {
          result.name = 'newname';
          return PetApiFactory().updatePet(result, requestOptions).then(() => {
            return PetApiFactory().getPetById(fixture.id, requestOptions).then( (result) => {
      ...
      it('should delete Pet', () => {
        return PetApiFactory().deletePet(fixture.id, requestOptions);
      });
