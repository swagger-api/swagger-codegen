...
FakeApiService
Test serialization of outer boolean types
 Support streaming responses without preloading content.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FakeOuterBooleanSerializeOpts - Optional Parameters:
     * @param "Body" (optional.Interface of OuterBoolean) -  Input boolean as post body

*/
func (a *FakeApiService) FakeOuterBooleanSerializeStream(ctx context.Context, localVarOptionals *FakeOuterBooleanSerializeOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
		...
		localVarOptionalBody, localVarOptionalBodyok := localVarOptionals.Body.Value().(OuterBoolean)
		if !localVarOptionalBodyok {
				return nil, reportError("body should be OuterBoolean")
		}
		localVarPostBody = &localVarOptionalBody
	}
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
...
*/
func (a *FakeApiService) FakeOuterCompositeSerializeStream(ctx context.Context, localVarOptionals *FakeOuterCompositeSerializeOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
		...
		localVarOptionalBody, localVarOptionalBodyok := localVarOptionals.Body.Value().(OuterComposite)
		if !localVarOptionalBodyok {
				return nil, reportError("body should be OuterComposite")
		}
		localVarPostBody = &localVarOptionalBody
	}
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
...
*/
func (a *FakeApiService) FakeOuterNumberSerializeStream(ctx context.Context, localVarOptionals *FakeOuterNumberSerializeOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
		...
		localVarOptionalBody, localVarOptionalBodyok := localVarOptionals.Body.Value().(OuterNumber)
		if !localVarOptionalBodyok {
				return nil, reportError("body should be OuterNumber")
		}
		localVarPostBody = &localVarOptionalBody
	}
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
...
*/
func (a *FakeApiService) FakeOuterStringSerializeStream(ctx context.Context, localVarOptionals *FakeOuterStringSerializeOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
		...
		localVarOptionalBody, localVarOptionalBodyok := localVarOptionals.Body.Value().(OuterString)
		if !localVarOptionalBodyok {
				return nil, reportError("body should be OuterString")
		}
		localVarPostBody = &localVarOptionalBody
	}
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
...
*/
func (a *FakeApiService) TestBodyWithQueryParamsStream(ctx context.Context, body User, query string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *FakeApiService) TestClientModelStream(ctx context.Context, body Client) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *FakeApiService) TestEndpointParametersStream(ctx context.Context, number float32, double float64, patternWithoutDelimiter string, byte_ string, localVarOptionals *TestEndpointParametersOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *FakeApiService) TestEnumParametersStream(ctx context.Context, localVarOptionals *TestEnumParametersOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *FakeApiService) TestInlineAdditionalPropertiesStream(ctx context.Context, param interface{}) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *FakeApiService) TestJsonFormDataStream(ctx context.Context, param string, param2 string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
