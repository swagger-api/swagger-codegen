...
PetApiService
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PetApiDoCategoryStuffOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SubCategory) - 
...
func (a *PetApiService) DoCategoryStuff(ctx context.Context, localVarOptionals *PetApiDoCategoryStuffOpts) (ModelApiResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/pet/category"
...
*/
func (a *PetApiService) GetAllPets(ctx context.Context) ([]InlineArrayItemsAllPetsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []InlineArrayItemsAllPetsResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/allPets"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []InlineArrayItemsAllPetsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *PetApiService) GetRandomPet(ctx context.Context) (SinglePetResponse, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SinglePetResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/randomPet"
