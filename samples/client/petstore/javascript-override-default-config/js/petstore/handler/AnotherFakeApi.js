...
(function(root, factory) {
  ...
  /**
   * AnotherFake service.
   * @module petstore/handler/AnotherFakeApi
   * @version 1.0.0
   */

  /**
   * Constructs a new AnotherFakeApi. 
   * @alias module:petstore/handler/AnotherFakeApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:petstore/handler/AnotherFakeApi~testSpecialTagsCallback
     ...
     * @param {module:petstore/handler/AnotherFakeApi~testSpecialTagsCallback} callback The callback function, accepting three arguments: error, data, response
