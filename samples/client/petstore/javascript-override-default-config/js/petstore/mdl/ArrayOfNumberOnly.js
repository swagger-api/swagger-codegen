...
(function(root, factory) {
   ...
   * @module petstore/mdl/ArrayOfNumberOnly
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ArrayOfNumberOnly</code>.
   * @alias module:petstore/mdl/ArrayOfNumberOnly
   * @class
   */
   ...
   * @param {module:petstore/mdl/ArrayOfNumberOnly} obj Optional instance to populate.
   * @return {module:petstore/mdl/ArrayOfNumberOnly} The populated <code>ArrayOfNumberOnly</code> instance.
   */
