...
(function(root, factory) {
   ...
   * @module petstore/mdl/ArrayOfArrayOfNumberOnly
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ArrayOfArrayOfNumberOnly</code>.
   * @alias module:petstore/mdl/ArrayOfArrayOfNumberOnly
   * @class
   */
   ...
   * @param {module:petstore/mdl/ArrayOfArrayOfNumberOnly} obj Optional instance to populate.
   * @return {module:petstore/mdl/ArrayOfArrayOfNumberOnly} The populated <code>ArrayOfArrayOfNumberOnly</code> instance.
   */
