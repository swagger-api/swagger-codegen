...
(function(root, factory) {
   ...
   * @module petstore/mdl/HasOnlyReadOnly
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HasOnlyReadOnly</code>.
   * @alias module:petstore/mdl/HasOnlyReadOnly
   * @class
   */
   ...
   * @param {module:petstore/mdl/HasOnlyReadOnly} obj Optional instance to populate.
   * @return {module:petstore/mdl/HasOnlyReadOnly} The populated <code>HasOnlyReadOnly</code> instance.
   */
