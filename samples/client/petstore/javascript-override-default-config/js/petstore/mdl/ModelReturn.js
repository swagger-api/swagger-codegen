...
(function(root, factory) {
   ...
   * @module petstore/mdl/ModelReturn
   * @version 1.0.0
   */
   ...
   * @alias module:petstore/mdl/ModelReturn
   * @class
   */
   ...
   * @param {module:petstore/mdl/ModelReturn} obj Optional instance to populate.
   * @return {module:petstore/mdl/ModelReturn} The populated <code>ModelReturn</code> instance.
   */
   ...
   */
  exports.prototype._return = undefined;
