...
(function(root, factory) {
   ...
   * @module petstore/mdl/NumberOnly
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>NumberOnly</code>.
   * @alias module:petstore/mdl/NumberOnly
   * @class
   */
   ...
   * @param {module:petstore/mdl/NumberOnly} obj Optional instance to populate.
   * @return {module:petstore/mdl/NumberOnly} The populated <code>NumberOnly</code> instance.
   */
