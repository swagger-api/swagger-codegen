...
(function(root, factory) {
   ...
   * @module petstore/mdl/List
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>List</code>.
   * @alias module:petstore/mdl/List
   * @class
   */
   ...
   * @param {module:petstore/mdl/List} obj Optional instance to populate.
   * @return {module:petstore/mdl/List} The populated <code>List</code> instance.
   */
