...
(function(root, factory) {
   ...
   * @module petstore/mdl/User
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>User</code>.
   * @alias module:petstore/mdl/User
   * @class
   */
   ...
   * @param {module:petstore/mdl/User} obj Optional instance to populate.
   * @return {module:petstore/mdl/User} The populated <code>User</code> instance.
   */
