...
(function(root, factory) {
   ...
   * @module petstore/mdl/ReadOnlyFirst
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ReadOnlyFirst</code>.
   * @alias module:petstore/mdl/ReadOnlyFirst
   * @class
   */
   ...
   * @param {module:petstore/mdl/ReadOnlyFirst} obj Optional instance to populate.
   * @return {module:petstore/mdl/ReadOnlyFirst} The populated <code>ReadOnlyFirst</code> instance.
   */
