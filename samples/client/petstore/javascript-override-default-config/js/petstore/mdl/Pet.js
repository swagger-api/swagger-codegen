...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['petstore/ApiClient', 'petstore/mdl/Category', 'petstore/mdl/Tag'], factory);
   ...
   * @module petstore/mdl/Pet
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Pet</code>.
   * @alias module:petstore/mdl/Pet
   * @class
   * @param name {String} 
   ...
   * @param {module:petstore/mdl/Pet} obj Optional instance to populate.
   * @return {module:petstore/mdl/Pet} The populated <code>Pet</code> instance.
   */
  ...
  /**
   * @member {module:petstore/mdl/Category} category
   */
  ...
  /**
   * @member {Array.<module:petstore/mdl/Tag>} tags
   */
  exports.prototype.tags = undefined;

  /**
   * pet status in the store
   * @member {module:petstore/mdl/Pet.StatusEnum} status
   */
