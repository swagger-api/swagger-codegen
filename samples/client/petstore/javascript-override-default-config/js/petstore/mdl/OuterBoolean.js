...
(function(root, factory) {
   ...
   * @module petstore/mdl/OuterBoolean
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OuterBoolean</code>.
   * @alias module:petstore/mdl/OuterBoolean
   * @class
   */
   ...
   * @param {module:petstore/mdl/OuterBoolean} obj Optional instance to populate.
   * @return {module:petstore/mdl/OuterBoolean} The populated <code>OuterBoolean</code> instance.
   */
