...
(function(root, factory) {
   ...
   * @module petstore/mdl/Capitalization
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Capitalization</code>.
   * @alias module:petstore/mdl/Capitalization
   * @class
   */
   ...
   * @param {module:petstore/mdl/Capitalization} obj Optional instance to populate.
   * @return {module:petstore/mdl/Capitalization} The populated <code>Capitalization</code> instance.
   */
