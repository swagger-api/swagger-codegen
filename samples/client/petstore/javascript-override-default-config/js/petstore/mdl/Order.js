...
(function(root, factory) {
   ...
   * @module petstore/mdl/Order
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Order</code>.
   * @alias module:petstore/mdl/Order
   * @class
   */
   ...
   * @param {module:petstore/mdl/Order} obj Optional instance to populate.
   * @return {module:petstore/mdl/Order} The populated <code>Order</code> instance.
   */
  ...
  /**
   * Order Status
   * @member {module:petstore/mdl/Order.StatusEnum} status
   */
