...
(function(root, factory) {
   ...
   * @module petstore/mdl/SpecialModelName
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SpecialModelName</code>.
   * @alias module:petstore/mdl/SpecialModelName
   * @class
   */
   ...
   * @param {module:petstore/mdl/SpecialModelName} obj Optional instance to populate.
   * @return {module:petstore/mdl/SpecialModelName} The populated <code>SpecialModelName</code> instance.
   */
