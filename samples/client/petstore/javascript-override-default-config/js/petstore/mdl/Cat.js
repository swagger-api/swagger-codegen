...
(function(root, factory) {
   ...
   * @module petstore/mdl/Cat
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Cat</code>.
   * @alias module:petstore/mdl/Cat
   * @class
   ...
   * @param {module:petstore/mdl/Cat} obj Optional instance to populate.
   * @return {module:petstore/mdl/Cat} The populated <code>Cat</code> instance.
   */
