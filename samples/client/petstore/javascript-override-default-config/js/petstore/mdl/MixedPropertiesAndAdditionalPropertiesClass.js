...
(function(root, factory) {
   ...
   * @module petstore/mdl/MixedPropertiesAndAdditionalPropertiesClass
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MixedPropertiesAndAdditionalPropertiesClass</code>.
   * @alias module:petstore/mdl/MixedPropertiesAndAdditionalPropertiesClass
   * @class
   */
   ...
   * @param {module:petstore/mdl/MixedPropertiesAndAdditionalPropertiesClass} obj Optional instance to populate.
   * @return {module:petstore/mdl/MixedPropertiesAndAdditionalPropertiesClass} The populated <code>MixedPropertiesAndAdditionalPropertiesClass</code> instance.
   */
  ...
  /**
   * @member {Object.<String, module:petstore/mdl/Animal>} map
   */
