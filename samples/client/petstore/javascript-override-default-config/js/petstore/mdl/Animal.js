...
(function(root, factory) {
   ...
   * @module petstore/mdl/Animal
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Animal</code>.
   * @alias module:petstore/mdl/Animal
   * @class
   ...
   * @param {module:petstore/mdl/Animal} obj Optional instance to populate.
   * @return {module:petstore/mdl/Animal} The populated <code>Animal</code> instance.
   */
