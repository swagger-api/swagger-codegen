...
(function(root, factory) {
   ...
   * @module petstore/mdl/OuterString
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OuterString</code>.
   * @alias module:petstore/mdl/OuterString
   * @class
   */
   ...
   * @param {module:petstore/mdl/OuterString} obj Optional instance to populate.
   * @return {module:petstore/mdl/OuterString} The populated <code>OuterString</code> instance.
   */
