...
(function(root, factory) {
   ...
   * @module petstore/mdl/Dog
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Dog</code>.
   * @alias module:petstore/mdl/Dog
   * @class
   * @extends module:petstore/mdl/Animal
   ...
   * @param {module:petstore/mdl/Dog} obj Optional instance to populate.
   * @return {module:petstore/mdl/Dog} The populated <code>Dog</code> instance.
   */
