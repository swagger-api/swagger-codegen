  ...
  describe('petstore', function() {
    describe('ArrayOfArrayOfNumberOnly', function() {
      ...
      it('should create an instance of ArrayOfArrayOfNumberOnly', function() {
        // TODO: update the code to test ArrayOfArrayOfNumberOnly
      ...
      it('should have the property arrayArrayNumber (base name: "ArrayArrayNumber")', function() {
        // TODO: update the code to test the property arrayArrayNumber
        expect(instance).to.have.property('arrayArrayNumber');
        // expect(instance.arrayArrayNumber).to.be(expectedValueLiteral);
      });
