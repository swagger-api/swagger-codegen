...
(function(root, factory) {
  ...
  function getTestData(pointer) {
    return testDataCache.get('/petstore/FakeClassnameTags123Api' + pointer);
  }
    ...
    describe('FakeClassnameTags123Api', function() {
      describe('testClassname', function() {
        it('should call testClassname successfully', function(done) {
          var body = getTestData('/testClassname/body');
          ...
          instance.testClassname(body, function(error, data, response) {
            ...
            let expected = getTestData('/testClassname/response');
