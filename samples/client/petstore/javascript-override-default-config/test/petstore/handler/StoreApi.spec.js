...
(function(root, factory) {
  ...
  function getTestData(pointer) {
    return testDataCache.get('/petstore/StoreApi' + pointer);
  }
    ...
    describe('StoreApi', function() {
      describe('deleteOrder', function() {
        it('should call deleteOrder successfully', function(done) {
          var orderId = getTestData('/deleteOrder/orderId');
      ...
      describe('getInventory', function() {
        it('should call getInventory successfully', function(done) {
          ...
          instance.getInventory(function(error, data, response) {
            ...
            let expected = getTestData('/getInventory/response');
      ...
      describe('getOrderById', function() {
        it('should call getOrderById successfully', function(done) {
          var orderId = getTestData('/getOrderById/orderId');
          ...
          instance.getOrderById(orderId, function(error, data, response) {
            ...
            let expected = getTestData('/getOrderById/response');
            assertEquals(expected, data);
      ...
      describe('placeOrder', function() {
        it('should call placeOrder successfully', function(done) {
          var body = getTestData('/placeOrder/body');
          ...
          instance.placeOrder(body, function(error, data, response) {
            ...
            let expected = getTestData('/placeOrder/response');
            assertEquals(expected, data);
