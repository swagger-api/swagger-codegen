...
open class FakeAPI: APIBase {
     ...
     */
    open class func testEndpointParameters(body: Object) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func testEnumParameters(body: Object? = nil, enumHeaderStringArray: [String]? = nil, enumHeaderString: String? = nil, enumQueryStringArray: [String]? = nil, enumQueryString: String? = nil, enumQueryInteger: Int32? = nil) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func testJsonFormData(body: Object) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
