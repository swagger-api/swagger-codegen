...
open class FormatTest: JSONEncodable {
    ...
    public init(integer: Int32?=nil, int32: Int32?=nil, int64: Int64?=nil, number: BigDecimal, float: Float?=nil, double: Double?=nil, string: String?=nil, byte: String, binary: String?=nil, date: ISOFullDate, dateTime: Date?=nil, uuid: UUID?=nil, password: String) {
