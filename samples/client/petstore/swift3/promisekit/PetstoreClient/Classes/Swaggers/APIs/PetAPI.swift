...
open class PetAPI: APIBase {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func deletePet( petId: Int32,  apiKey: String? = nil) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Pet>
     */
    open class func getPetById( petId: Int32) -> Promise<Pet> {
        let deferred = Promise<Pet>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func updatePetWithForm( petId: Int32,  name: String? = nil,  status: String? = nil) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
     ...
     */
    open class func uploadFile( petId: Int32,  additionalMetadata: String? = nil,  file: URL? = nil) -> Promise<ApiResponse> {
