...
open class FakeAPI: APIBase {
    ...
    /**
     ...
     - returns: Promise<[Definition1]>
     */
    open class func definition1() -> Promise<[Definition1]> {
        let deferred = Promise<[Definition1]>.pending()
  ...
  <Id>aeiou</Id>
    ...
    /**
     ...
     - returns: Promise<[Definition2]>
     */
    open class func definition2() -> Promise<[Definition2]> {
        let deferred = Promise<[Definition2]>.pending()
  ...
  <Id>aeiou</Id>
    ...
    /**
     ...
     - returns: Promise<[Definition3]>
     */
    open class func definition3() -> Promise<[Definition3]> {
        let deferred = Promise<[Definition3]>.pending()
  ...
  <Id>aeiou</Id>
     ...
     */
    open class func postJSON( items: Int64) -> Promise<Void> {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func postJSON_0( items: [Int64]) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func postJSON_1( body: Any) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
