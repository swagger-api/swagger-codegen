...
open class FakeAPI: APIBase {
  ...
  "client" : "aeiou"
     ...
     */
    open class func testEndpointParameters( number: Double,  double: Double,  patternWithoutDelimiter: String,  byte: Data,  integerArrayRequired: [Int64],  integer: Int32? = nil,  int32: Int32? = nil,  int64: Int64? = nil,  float: Float? = nil,  string: String? = nil,  binary: Data? = nil,  date: ISOFullDate? = nil,  dateTime: Date? = nil,  password: String? = nil,  callback: String? = nil,  integerArrayNotRequired: [Int64]? = nil) -> Promise<Void> {
