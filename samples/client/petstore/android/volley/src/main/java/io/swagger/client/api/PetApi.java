...
public class PetApi {
    ...
    /**
     * Finds Pets by tags Muliple tags can be provided with comma seperated strings. Use tag1, tag2,
     * tag3 for testing.
     *
    ...
    /**
     * Find pet by ID Returns a pet when ID &lt; 10.  ID &gt; 10 or nonintegers will simulate API
     * error conditions
     *
     ...
     * Updates a pet in the store with form data
     *
     * @param petId ID of pet that needs to be updated   * @param name Updated name of the pet   *
     *              @param status Updated status of the pet
     */
     ...
     * uploads an image
     *
     * @param petId ID of pet to update   * @param additionalMetadata Additional data to pass to
     *              server   * @param file file to upload
     */
