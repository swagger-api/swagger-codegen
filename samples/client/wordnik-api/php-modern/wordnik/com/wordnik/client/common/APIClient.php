 ...
 * APIClient.php
 */
namespace com\wordnik\client\common;
...
class APIClient {
	 ...
	 */
	function __construct($apiKey, $apiServer, $timeout = self::DEFAULT_TIMEOUT) {
		$this->apiKey = $apiKey;
	 ...
	 * @return Object|null the response object or null if HTTP status code is 404
	 * @throws Exception if HTTP status code isn't 200 or 404
	 */
	...
	public static function deserialize($object, $class) {
		...
		if (substr($class, 0, 6) == 'array[') {
			...
			$class = '\com\wordnik\client\model\\' . $class;
