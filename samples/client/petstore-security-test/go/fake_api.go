 ...
 *
 * @param testCodeInjectEndRnNR(nil) To test code injection *_/ &#39; \&quot; &#x3D;end -- \\r\\n \\n \\r 
 * @return nil
 */
func (a FakeApi) TestCodeInjectEndRnNR(testCodeInjectEndRnNR interface{}) (*APIResponse, error) {
	...
	if err := a.Configuration.APIClient.typeCheckParameter(testCodeInjectEndRnNR, "string", "testCodeInjectEndRnNR"); err != nil {
		return  nil, err
	}
