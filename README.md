...
You can also download the JAR (latest relesae) directly from [maven.org]( http://central.maven.org/maven2/com/wordnik/swagger-codegen-cli/2.1.0-M2/swagger-codegen-cli-2.1.0-M2.jar)
