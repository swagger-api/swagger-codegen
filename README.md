...
-------------------------- |--------------| -------------------------- | -----
[3.0.66](https://github.com/swagger-api/swagger-codegen/releases/tag/v3.0.66) (**current stable**) | 2024-12-23   | 1.0, 1.1, 1.2, 2.0, 3.0   | [tag v3.0.66](https://github.com/swagger-api/swagger-codegen/tree/v3.0.66)
