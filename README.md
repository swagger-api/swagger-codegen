...
-------------------------- |--------------| -------------------------- | -----
[3.0.74](https://github.com/swagger-api/swagger-codegen/releases/tag/v3.0.73) (**current stable**) | 2025-09-16   | 1.0, 1.1, 1.2, 2.0, 3.0   | [tag v3.0.74](https://github.com/swagger-api/swagger-codegen/tree/v3.0.74)
[2.4.48](https://github.com/swagger-api/swagger-codegen/releases/tag/v2.4.47) (**current stable**) | 2025-09-16   | 1.0, 1.1, 1.2, 2.0   | [tag v2.4.48](https://github.com/swagger-api/swagger-codegen/tree/v2.4.48)

💁 Here's also an overview of what's coming around the corner:

Swagger Codegen Version    | Release Date | Swagger / OpenAPI Spec compatibility | Notes
-------------------------- |--------------| -------------------------- | -----
3.0.75-SNAPSHOT (current 3.0.0, upcoming minor release) [SNAPSHOT](https://central.sonatype.com/service/rest/repository/browse/maven-snapshots/io/swagger/codegen/v3/swagger-codegen-cli/3.0.75-SNAPSHOT/)| TBD          | 1.0, 1.1, 1.2, 2.0, 3.0 | Minor release
2.4.49-SNAPSHOT (current master, upcoming minor release) [SNAPSHOT](https://central.sonatype.com/service/rest/repository/browse/maven-snapshots/io/swagger/swagger-codegen-cli/2.4.49-SNAPSHOT/)| TBD          | 1.0, 1.1, 1.2, 2.0   | Minor release
