...
```
java -jar modules/swagger-codegen-distribution/target/swagger-cli.jar generate \
...
```
java -jar modules/swagger-codegen-distribution/target/swagger-cli.jar meta \
