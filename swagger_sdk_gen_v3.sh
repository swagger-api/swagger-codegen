...
then 
  rm -rf intouch_api/java_client/java
    ...
    mvn3 clean deploy -f intouch_api/java_client/java/pom.xml -DaltDeploymentRepository=capillarymavensnapshotrepo::default::scp://reporead@ci.capillary.co.in/data/mvn/snapshots
