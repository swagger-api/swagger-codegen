<project xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://maven.apache.org/POM/4.0.0" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">
    ...
    <properties>
        <swagger-codegen-generators-version>1.0.7-SNAPSHOT</swagger-codegen-generators-version>
        <swagger-core-version>2.0.7</swagger-core-version>
        <swagger-core-version-v1>1.5.22</swagger-core-version-v1>
        <swagger-parser-version>2.0.10</swagger-parser-version>
        <swagger-parser-version-v1>1.0.43</swagger-parser-version-v1>
