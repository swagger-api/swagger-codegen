...
cd ../..
java -jar $BASE_JAR generate -i $JSON_FILE -DinvokerPackage="io.knetik.client",modelPackage="io.knetik.model",apiPackage="io.knetik.api" -l java $ID_FLAGS --artifact-id splyt-java-client -o sdk/java
cd sdk/java
